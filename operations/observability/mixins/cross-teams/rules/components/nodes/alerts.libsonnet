        ...
        rules: [
          {
            ...
            'for': '10m',
            annotations: {
              runbook_url: 'https://github.com/khulnasoft/runbooks/blob/main/runbooks/NxpodNodeRunningOutOfEphemeralStorage.md',
          ...
          },
          {
            ...
            'for': '5m',
            annotations: {
              runbook_url: 'https://github.com/khulnasoft/runbooks/blob/main/runbooks/NxpodNodeConntrackTableIsFull.md',
