...
if [ -f "/usr/local/nxpod/config/initial-spec.json" ]; then
  gcloud iam workload-identity-pools create-cred-config \
    projects/184212049955/locations/global/workloadIdentityPools/nxpod-flex/providers/nxpod-flex-provider \
    ...
    --executable-command='node /workspace/nxpod/dev/flex-oidc/oidc.js' \
