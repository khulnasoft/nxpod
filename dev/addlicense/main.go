...
var (
	holder    = flag.String("c", "Nxpod GmbH", "copyright holder")
...
func removeLicense(path string, fmode os.FileMode, tmpl *template.Template, data *copyrightData) (haslic bool, modified bool, err error) {
	...
	b = bytes.ReplaceAll(b, []byte("Copyright (c) 2021 Nxpod GmbH."), []byte("Copyright (c) 2022 Nxpod GmbH."))
	b = bytes.ReplaceAll(b, []byte("Copyright (c) 2020 Nxpod GmbH."), []byte("Copyright (c) 2022 Nxpod GmbH."))
