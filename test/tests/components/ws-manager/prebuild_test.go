...
// - make sure the workspace's init task ran (the init task will create a file `incremental.txt` see https://github.com/khulnasoft/test-incremental-workspace/blob/main/.nxpod.yml)
