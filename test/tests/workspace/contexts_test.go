...
import (
	...
	"github.com/khulnasoft/nxpod/test/pkg/report"
)
...
func TestGitHubContexts(t *testing.T) {
	tests := []ContextTest{
		...
		{
			Name:           "open branch",
			ContextURL:     "github.com/khulnasoft/nxpod-test-repo/tree/integration-test-1",
		...
		},
		{
			...
			Name:          "open issue",
			ContextURL:    "github.com/khulnasoft/nxpod-test-repo/issues/88",
			WorkspaceRoot: "/workspace/nxpod-test-repo",
		},
		{
			Name:           "open tag",
			ContextURL:     "github.com/khulnasoft/nxpod-test-repo/tree/integration-test-context-tag",
			WorkspaceRoot:  "/workspace/nxpod-test-repo",
			ExpectedBranch: "HEAD",
		},
		{
