...
import (
	...
	"github.com/khulnasoft/nxpod/common-go/grpc"
	"github.com/khulnasoft/nxpod/common-go/util"
	storageconfig "github.com/khulnasoft/nxpod/content-service/api/config"
...
func configmap(ctx *common.RenderContext) ([]runtime.Object, error) {
	...
	if ctx.Config.Kind == configv1.InstallationWorkspace {
		...
		// (https://github.com/khulnasoft/nxpod/issues/7845).
