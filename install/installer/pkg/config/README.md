...
> For an in-depth discussion on the reasons for replacing Helm, please see [our blog post](https://www.nxpod.khulnasoft.com/blog/nxpod-installer) or the talk [Why We Chose To Ditch Helm To Gain Open Source Sanity](https://www.youtube.com/watch?v=W1-cZUXh4zM&ab_channel=CloudNativeRejekts)
...
| WebApp    | Components deployed to nodes with the `nxpod.io/workload_meta` label.                                                                                                   |
| IDE       | Components deployed to nodes with the `nxpod.io/workload_ide` label.                                                                                                    |
| Workspace | Components deployed to nodes with the `nxpod.io/workload_workspace_headless`, `nxpod.io/workload_workspace_regular` or `nxpod.io/workload_services` labels. |
