...
import (
	...
	"github.com/khulnasoft/nxpod/installer/pkg/config/versions"
...
func TestConfigcatEnvOutOfCluster(t *testing.T) {
	...
	require.Equal(t, envVars, []v1.EnvVar([]v1.EnvVar{{Name: "CONFIGCAT_SDK_KEY", Value: "nxpod"}, {Name: "CONFIGCAT_BASE_URL", Value: "https://nxpod.io/configcat"}}))
}
