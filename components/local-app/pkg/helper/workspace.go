...
func OpenWorkspaceInPreferredEditor(ctx context.Context, clnt *client.Nxpod, workspaceID string) error {
...
func SSHConnectToWorkspace(ctx context.Context, clnt *client.Nxpod, workspaceID string, runDry bool, sshArgs ...string) error {
	workspace, err := clnt.Workspaces.GetWorkspace(ctx, connect.NewRequest(&v1.GetWorkspaceRequest{WorkspaceId: workspaceID}))
	if err != nil {
		return err
	}
...
func ObserveWorkspaceUntilStarted(ctx context.Context, clnt *client.Nxpod, workspaceID string) (*v1.WorkspaceStatus, error) {
