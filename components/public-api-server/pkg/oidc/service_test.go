...
func Test_verifyCelExpression(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			CEL: "(claims.email_verified && claims.email_verified.email.endsWith('@khulnasoft.com')) || 'nxpod-team' in claims.groups_direct",
		},
		{
			...
			CEL: "(claims.email_verified && claims.email_verified.email.endsWith('@khulnasoft.com')) || 'nxpod-team2' in claims.groups_direct",
		},
		{
