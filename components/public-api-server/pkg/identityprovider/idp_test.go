...
const (
	issuerBaseURL = "https://api.nxpod.io/idp"
)
...
func TestRouter(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			Expectation: Expectation{
				Response: `{"issuer":"https://api.nxpod.io/idp","authorization_endpoint":"https://api.nxpod.io/idp/not-supported","token_endpoint":"https://api.nxpod.io/idp/not-supported","introspection_endpoint":"https://api.nxpod.io/idp/not-supported","userinfo_endpoint":"https://api.nxpod.io/idp/not-supported","revocation_endpoint":"https://api.nxpod.io/idp/not-supported","end_session_endpoint":"https://api.nxpod.io/idp/not-supported","jwks_uri":"https://api.nxpod.io/idp/keys","scopes_supported":["openid","profile","email","phone","address","offline_access"],"response_types_supported":["code","id_token","id_token token"],"grant_types_supported":["authorization_code","implicit"],"subject_types_supported":["public"],"id_token_signing_alg_values_supported":["RS256"],"revocation_endpoint_auth_methods_supported":["none"],"introspection_endpoint_auth_methods_supported":["none"],"introspection_endpoint_auth_signing_alg_values_supported":["RS256"],"claims_supported":["sub","aud","exp","iat","iss","auth_time","nonce","acr","amr","c_hash","at_hash","act","scopes","client_id","azp","preferred_username","name","family_name","given_name","locale","email"],"request_uri_parameter_supported":false}` + "\n",
			},
			ExpectedHeaders: map[string]string{
			...
			Expectation: Expectation{
				Token: &jwt.Token{
					...
					Claims: jwt.MapClaims{
						...
						"iss":  string("https://api.nxpod.io/idp"),
						"name": "foo",
						"sub":  "bar",
					},
					Valid: true,
