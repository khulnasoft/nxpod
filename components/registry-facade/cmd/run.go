...
import (
	...
	"github.com/khulnasoft/nxpod/common-go/kubernetes"
	"github.com/khulnasoft/nxpod/common-go/log"
	"github.com/khulnasoft/nxpod/common-go/pprof"
	"github.com/khulnasoft/nxpod/common-go/watch"
	"github.com/khulnasoft/nxpod/registry-facade/api/config"
...
var runCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		gpreg := prometheus.WrapRegistererWithPrefix("nxpod_registry_facade_", promreg)
