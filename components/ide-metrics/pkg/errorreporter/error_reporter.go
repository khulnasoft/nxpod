...
// NewFromEnvironment creates a new error report instance based on the NXPOD_ENABLED_ERROR_REPORTING
// environment variable. This function never returns nil
func NewFromEnvironment() ErrorReporter {
	isEnabled := os.Getenv("NXPOD_ENABLED_ERROR_REPORTING") == "true"
	if !isEnabled {
