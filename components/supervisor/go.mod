module github.com/khulnasoft/nxpod/supervisor
...
replace github.com/khulnasoft/nxpod/ide-metrics-api => ../ide-metrics-api/go // leeway

replace github.com/khulnasoft/nxpod/supervisor/api => ../supervisor-api/go // leeway

replace github.com/khulnasoft/nxpod/ws-daemon/api => ../ws-daemon-api/go // leeway
