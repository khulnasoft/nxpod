...
import { WorkspaceStatus, WorkspaceLogMessage, SubscribeRequest, SubscribeResponse, GetWorkspacesRequest, WorkspaceManagerClient, PromisifiedWorkspaceManagerClient } from "@nxpod/ws-manager/lib";
