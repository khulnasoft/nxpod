...
type WorkspaceInfoResponse struct {
	...
	NxpodApi *WorkspaceInfoResponse_NxpodAPI `protobuf:"bytes,7,opt,name=nxpod_api,json=nxpodApi,proto3" json:"nxpod_api,omitempty"`
	// nxpod_host provides Nxpod host URL.
	NxpodHost string `protobuf:"bytes,8,opt,name=nxpod_host,json=nxpodHost,proto3" json:"nxpod_host,omitempty"`
...
func (x *WorkspaceInfoResponse) GetNxpodApi() *WorkspaceInfoResponse_NxpodAPI {
	if x != nil {
		return x.NxpodApi
	}
	return nil
...
func (x *WorkspaceInfoResponse) GetNxpodHost() string {
	if x != nil {
		return x.NxpodHost
	}
	return ""
...
type WorkspaceInfoResponse_NxpodAPI struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *WorkspaceInfoResponse_NxpodAPI) Reset() {
	*x = WorkspaceInfoResponse_NxpodAPI{}
	if protoimpl.UnsafeEnabled {
...
func (x *WorkspaceInfoResponse_NxpodAPI) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WorkspaceInfoResponse_NxpodAPI) ProtoMessage() {}

func (x *WorkspaceInfoResponse_NxpodAPI) ProtoReflect() protoreflect.Message {
	mi := &file_info_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WorkspaceInfoResponse_NxpodAPI.ProtoReflect.Descriptor instead.
func (*WorkspaceInfoResponse_NxpodAPI) Descriptor() ([]byte, []int) {
	return file_info_proto_rawDescGZIP(), []int{1, 0}
}

func (x *WorkspaceInfoResponse_NxpodAPI) GetEndpoint() string {
	if x != nil {
		return x.Endpoint
	}
	return ""
...
func (x *WorkspaceInfoResponse_NxpodAPI) GetHost() string {
	if x != nil {
		return x.Host
	}
	return ""
...
var file_info_proto_goTypes = []interface{}{
	...
	(*WorkspaceInfoResponse_NxpodAPI)(nil),      // 3: supervisor.WorkspaceInfoResponse.NxpodAPI
...
var file_info_proto_depIdxs = []int32{
	3, // 0: supervisor.WorkspaceInfoResponse.nxpod_api:type_name -> supervisor.WorkspaceInfoResponse.NxpodAPI
...
func file_info_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_info_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*WorkspaceInfoResponse_NxpodAPI); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
