...
COPY components-dashboard--app/node_modules/@nxpod/dashboard/dist /www/data/dashboard
COPY components-dashboard--app/node_modules/@nxpod/dashboard/public/libs /www/data/dashboard/libs
