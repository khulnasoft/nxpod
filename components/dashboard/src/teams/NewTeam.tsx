    ...
    return (
        <div className="flex flex-col w-96 mt-24 mx-auto items-center">
            ...
            <Subheading className="text-center">
                <a href="https://www.nxpod.khulnasoft.com/docs/configure/teams" className="gp-link">
                    Organizations
                </a>{" "}
                allow you to manage related{" "}
                <a href="https://www.nxpod.khulnasoft.com/docs/configure/projects" className="gp-link">
                    projects
                </a>{" "}
