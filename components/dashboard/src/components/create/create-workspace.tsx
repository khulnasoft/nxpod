...
import { NxpodService, WorkspaceCreationResult, CreateWorkspaceMode } from '@nxpod/nxpod-protocol';
...
export type CreateErrorRenderer = (error: CreateWorkspaceError, service: NxpodService, retriggerStart: () => void) => JSX.Element | undefined;
                ...
                case ErrorCodes.NOT_AUTHENTICATED:
                    if (data) {
                        ...
                        if (this.props.contextUrl) {
                            url = new NxpodHostUrl(window.location.toString()).withApi({
                                pathname: '/login/',
        ...
        if (showWhitelistedRepoList) {
            return (
                <ApplicationFrame service={this.props.service}>
                    ...
                    <p>Until then, please try Nxpod with one of the repositories below:</p>
                    <Context.Consumer>
                        {(ctx) => 
