...
import { Workspace, WorkspaceInfo, WorkspaceInstance, DisposableCollection, WhitelistedRepository, NxpodServer, NxpodService, Configuration } from '@nxpod/nxpod-protocol';
...
class Workspaces extends React.Component<WorkspacesProps, WorkspacesState> {
	...
	private async updateWorkspaces(options?: NxpodServer.GetWorkspacesOptions) {
		try {
