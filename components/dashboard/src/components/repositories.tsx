...
import { WhitelistedRepository, NxpodService, DisposableCollection, NxpodServer } from '@nxpod/nxpod-protocol';
...
export class FeaturedRepositories extends React.Component<FeaturedRepositoryProps, FeaturedRepositoryState> {
	...
	private async updateRepositoryList(options?: NxpodServer.GetWorkspacesOptions) {
		try {
