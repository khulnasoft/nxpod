        ...
        <Dialog open={!!this.state.status}>
            ...
            <DialogContent>
                <Typography variant="body1">
                    ...
                    <div>If you ever decide to give Nxpod another try, just sign up like you did the first time. No hard feelings 🙂</div>
                </Typography>
            </DialogContent>
            <DialogActions>
                <Button onClick={() => window.location.href=new NxpodHostUrl(window.location.toString()).withApi({pathname: '/logout'}).toString()} color="secondary" variant="outlined">Finish</Button>
            </DialogActions>
            </React.Fragment>}
