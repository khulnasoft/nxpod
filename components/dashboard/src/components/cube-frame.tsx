    ...
    componentDidMount() {
        if (this.canvas != null && !this.state.fixedLogo) {
            try {
                ...
                let fixedLogo = "/images/nxpod-logo-no-text.svg";
        ...
        return (
            <div className='start'>
                ...
                { !!this.state.fixedLogo &&
                    <div className="nxpod-boot-logo-div">
                        <img className="nxpod-boot-logo" src={this.state.fixedLogo} />
                    </div>
                }
    ...
    protected getErrorMessage() {
        ...
        return (
            <div>
                ...
                <div>Please <a href="https://github.com/khulnasoft/nxpod/issues/new?template=bug_report.md"
