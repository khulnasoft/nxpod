...
import { NxpodService, AuthProviderInfo } from '@nxpod/nxpod-protocol';
    ...
    protected renderMessage() {
        ...
        if (authProviders) {
            ...
            if (!privatePermission) {
                ...
                if (!updatedRecently) {
                    message = (
                        <div className="text">Permission to access private repositories has been granted. If you are a member of '{owner}', try to <a href={link}>request access</a> for Nxpod.</div>
                    );
                } else {
                    message = (
                        <div className="text">Your access token was updated recently. <a href={link}>Try again</a> if the repository exists and Nxpod was approved for '{owner}'.</div>
                    );
                }
            }
        }
