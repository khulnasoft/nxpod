...
import { getPrimaryEmail, isOrganizationOwned } from "@nxpod/public-api-common/lib/user-utils";
import { User } from "@nxpod/public-api/lib/nxpod/v1/user_pb";
import { User as UserProtocol, ProfileDetails } from "@nxpod/nxpod-protocol";
...
export default function Account() {
    ...
    const deleteAccount = useCallback(async () => {
        await getNxpodService().server.deleteAccount();
        document.location.href = nxpodHostUrl.asApiLogout().toString();
    }, []);
        ...
        <div>
            ...
            >
                <ol className="text-gray-500 text-sm list-outside list-decimal">
                    ...
                    <li className="ml-5">
                        Your subscription will be cancelled. If you obtained a Nxpod subscription through the GitHub
            ...
            <PageWithSettingsSubMenu>
                ...
                <Subheading className="mb-3">
                    This action will remove all the data associated with your account in Nxpod.
                </Subheading>
