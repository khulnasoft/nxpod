        ...
        <Modal visible onClose={props.onClose} onSubmit={save}>
            ...
            <ModalBody>
                ...
                <Alert type="info" className="mt-2">
                    ...
                    <a
                        href="https://www.nxpod.khulnasoft.com/docs/configure/user-settings/ssh#create-an-ssh-key"
            ...
            <div className="flex items-start sm:justify-between mb-2">
                <div>
                    ...
                    <Subheading>
                        ...
                        <a
                            className="gp-link"
                            href="https://www.nxpod.khulnasoft.com/docs/configure/user-settings/ssh"
                            target="_blank"
                            rel="noreferrer"
                        >
                            Learn more
