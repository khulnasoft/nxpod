...
import { PersonalAccessToken } from "@nxpod/public-api/lib/nxpod/experimental/v1/tokens_pb";
        ...
        <>
                    ...
                    {tokens.length === 0 ? (
                        <div className="bg-gray-100 dark:bg-gray-800 rounded-xl w-full py-28 flex flex-col items-center">
                            ...
                            <Subheading className="text-center pb-6 w-96">
                                Generate an access token for applications that need access to the Nxpod API.{" "}
                            </Subheading>
                            <LinkButton href={settingsPathPersonalAccessTokenCreate}>New Access Token</LinkButton>
                        </div>
                    ) : (
            ...
            {modalData?.action === TokenAction.Delete && (
                <ShowTokenModal
                    ...
                    descriptionImportant="Any applications using this token will no longer be able to access the Nxpod API."
