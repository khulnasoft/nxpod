...
import NxpodClassicCard from "./images/nxpod-classic-card.png";
        ...
        <div className="rounded-xl px-10 py-10 mx-auto w-full max-w-lg">
            ...
            <div className="mx-auto text-center pb-8 space-y-2">
                {isDataOps ? (
                    ...
                    <>
                        <Heading1>Log in to Nxpod Classic</Heading1>
            ...
            <div>
                <div className="justify-center md:justify-start mb-6 md:mb-8">
                    ...
                    <p className="text-pk-content-secondary mb-2">
                        Automated, standardized development environments hosted by us in Nxpod’s infrastructure. Users
                        who joined before October 1, 2024 on non-Enterprise plans are considered Nxpod Classic users.
                    </p>
                    <div className="border border-pk-border-base rounded-xl p-4 bg-pk-surface-secondary mt-5">
                        <p className="text-gray-800 dark:text-gray-100">
                            <b>Please note:</b> Nxpod Classic will discontinued in April 2025 and replaced by{" "}
                            <a
                                className="gp-link font-semibold"
                                href="https://app.nxpod.io/login"
                                target="_blank"
                ...
                <img src={NxpodClassicCard} alt="Nxpod Classic" className="w-full" />
            </div>
        </div>
    );
};
    ...
    return (
        <div className="flex-none mx-auto text-center px-4 pb-4">
            <span className="text-gray-400 dark:text-gray-500 text-sm">
                ...
                <a className="gp-link hover:text-gray-600" target="nxpod-terms" href="https://www.nxpod.khulnasoft.com/terms/">
                    terms of service
                </a>{" "}
                and{" "}
                <a
