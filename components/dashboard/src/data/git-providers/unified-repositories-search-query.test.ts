...
test("should perform weak validation for git URLs", () => {
    ...
    expect(isValidGitUrl("https://github.com/khulnasoft/nxpod/pull/20281")).toEqual(true);
    expect(isValidGitUrl("https://gitlab.com/filiptronicek/nxpod.git")).toEqual(true);
    expect(isValidGitUrl("git@github.com:khulnasoft/nxpod.git")).toEqual(true);
    expect(isValidGitUrl("git@gitlab.com:filiptronicek/nxpod.git")).toEqual(true);
    expect(isValidGitUrl("ssh://login@server.com:12345/~/repository.git")).toBe(true);
    expect(isValidGitUrl("https://bitbucket.nxpod-dev.com/scm/~geropl/test-user-repo.git")).toBe(true);
    expect(isValidGitUrl("git://gitlab.com/nxpod/spring-petclinic")).toBe(true);
