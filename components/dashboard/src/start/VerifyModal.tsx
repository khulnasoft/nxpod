        ...
        return (
            ...
            >
                <Alert type="warning" className="mt-2">
                    To use Nxpod for free you'll need to validate your account with your phone number. This is required
                    to discourage and reduce abuse on Nxpod infrastructure.
                </Alert>
