...
export default function InstallGitHubApp() {
    const goToApp = () => (window.location.href = nxpodHostUrl.toString());
                ...
                <div className="px-6 py-3 flex justify-between space-x-2">
                    <div className="flex flex-col items-center m-auto max-w-lg mt-40">
                        ...
                        <Subheading className="text-center pb-6">
                            You likely tried to install the GitHub App for Nxpod.
                        </Subheading>
                        <InfoBox>Nxpod no longer requires to install the GitHub App on repositories.</InfoBox>
                        <div className="mt-6">
