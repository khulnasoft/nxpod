...
export class JsonRpcWorkspaceClient implements PromiseClient<typeof WorkspaceService> {
    ...
    async getWorkspace(request: PartialMessage<GetWorkspaceRequest>): Promise<GetWorkspaceResponse> {
        ...
        const info = await getNxpodService().server.getWorkspace(request.workspaceId);
    ...
    async listWorkspaces(
        ...
        let resultTotal = 0;
        const results = await getNxpodService().server.getWorkspaces({
            limit,
    ...
    async createAndStartWorkspace(
        ...
        const response = await getNxpodService().server.createWorkspace({
    ...
    async startWorkspace(request: PartialMessage<StartWorkspaceRequest>, _options?: CallOptions | undefined) {
        ...
        await getNxpodService().server.startWorkspace(request.workspaceId, {
    ...
    async getWorkspaceDefaultImage(
        ...
        const response = await getNxpodService().server.getDefaultWorkspaceImage({
    ...
    async sendHeartBeat(
        ...
        await getNxpodService().server.sendHeartBeat({
    ...
    async getWorkspaceOwnerToken(
        ...
        const ownerToken = await getNxpodService().server.getOwnerToken(request.workspaceId);
    ...
    async getWorkspaceEditorCredentials(
        ...
        const credentials = await getNxpodService().server.getIDECredentials(request.workspaceId);
    ...
    async updateWorkspace(
        ...
        const server = getNxpodService().server;
    ...
    async stopWorkspace(
        ...
        await getNxpodService().server.stopWorkspace(request.workspaceId);
    ...
    async deleteWorkspace(
        ...
        await getNxpodService().server.deleteWorkspace(request.workspaceId);
    ...
    async parseContextURL(
        ...
        const context = await getNxpodService().server.resolveContext(request.contextUrl);
    ...
    async listWorkspaceClasses(
        ...
        const list = await getNxpodService().server.getSupportedWorkspaceClasses();
    ...
    async createWorkspaceSnapshot(
        ...
        const snapshotId = await getNxpodService().server.takeSnapshot({
    ...
    async waitForWorkspaceSnapshot(
        ...
        await getNxpodService().server.waitForSnapshot(req.snapshotId);
    ...
    async updateWorkspacePort(
        ...
        getNxpodService().server.openPort(req.workspaceId, {
