...
import { AdmissionLevel, Workspace, WorkspacePhase_Phase } from "@nxpod/public-api/lib/nxpod/v1/workspace_pb";
...
export const WorkspaceEntryOverflowMenu: FunctionComponent<WorkspaceEntryOverflowMenuProps> = ({
    ...
    const startUrl = useMemo(
        () =>
            new NxpodHostUrl(window.location.href).with({
                pathname: "/start/",
                hash: "#" + workspace.id,
            }),
        [workspace.id],
    ...
    const downloadURL = useMemo(
        () =>
            new NxpodHostUrl(window.location.href)
                .with({
