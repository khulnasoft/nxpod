    ...
    window.onload = (ev: Event) => {
        try {
            ...
            if (parent) {
                ...
                img.className = "nxpod-boot-logo";
                img.src = new NxpodHostUrl(window.location.href).withoutWorkspacePrefix().with({pathname: "/images/nxpod-logo-no-text.svg"}).toString();

                const outerDiv = document.createElement("div");
                outerDiv.className = "nxpod-boot-logo-div";
