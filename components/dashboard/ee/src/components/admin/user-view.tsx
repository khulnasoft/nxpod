...
import { NxpodService, User, Permissions, RoleOrPermission, NamedWorkspaceFeatureFlag } from '@nxpod/nxpod-protocol';
...
export type AdditionalUserPropertiesRenderer = (service: NxpodService, user: User | undefined) => JSX.Element;
