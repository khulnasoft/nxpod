...
abstract class AbstractNxpodTerminalService(project: Project) : Disposable {
    private val lifetime = defineNestedLifetime()
    private val terminalServiceFutureStub = TerminalServiceGrpc.newFutureStub(NxpodManager.supervisorChannel)
    private val terminalServiceStub = TerminalServiceGrpc.newStub(NxpodManager.supervisorChannel)
    private val statusServiceStub = StatusServiceGrpc.newStub(NxpodManager.supervisorChannel)
