...
class NxpodWebSocketTunnelServer(
    ...
    private val clients = CopyOnWriteArrayList<NxpodWebSocketTunnelClient>()
    ...
    private fun handleClientConnection(clientSocket: Socket) {
        val socketClient = NxpodWebSocketTunnelClient(url, clientSocket)
        try {
    ...
    private fun connectToWebSocket(socketClient: NxpodWebSocketTunnelClient) {
...
class NxpodWebSocketTunnelClient(
    private val url: String,
