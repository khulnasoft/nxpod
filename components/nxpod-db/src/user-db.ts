...
import { User, Identity, IdentityLookup, Token, TokenEntry, UserEnvVar, NxpodTokenType, NxpodToken } from "@nxpod/nxpod-protocol"
import { Without } from "@nxpod/nxpod-protocol/lib/util/without";
...
export interface UserDB {
    ...
    findUserByNxpodToken(tokenHash: string, tokenType?: NxpodTokenType): Promise<MaybeUser>;
    findAllNxpodTokensOfUser(userId: string): Promise<NxpodToken[]>;
    storeNxpodToken(token: NxpodToken & { user: DBUser }): Promise<void>;
