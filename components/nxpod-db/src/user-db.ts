...
export interface UserDB extends OAuthUserRepository, OAuthTokenRepository, TransactionalDB<UserDB> {
    ...
    findUserByNxpodToken(
        tokenHash: string,
        tokenType?: NxpodTokenType,
    ): Promise<{ user: User; token: NxpodToken } | undefined>;
    findNxpodTokensOfUser(userId: string, tokenHash: string): Promise<NxpodToken | undefined>;
    findAllNxpodTokensOfUser(userId: string): Promise<NxpodToken[]>;
    storeNxpodToken(token: NxpodToken): Promise<void>;
    deleteNxpodToken(tokenHash: string): Promise<void>;
    deleteNxpodTokensNamedLike(userId: string, namePattern: string): Promise<void>;
