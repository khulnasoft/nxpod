...
import { encryptionModule } from "@nxpod/nxpod-protocol/lib/encryption/container-module";
import { KeyProviderImpl, KeyProviderConfig } from "@nxpod/nxpod-protocol/lib/encryption/key-provider";
...
import { NxpodTableDescriptionProvider, TableDescriptionProvider } from "./tables";
...
import { EncryptionService, GlobalEncryptionService } from "@nxpod/nxpod-protocol/lib/encryption/encryption-service";
...
export const dbContainerModule = (cacheClass = DataCacheNoop) =>
    new ContainerModule((bind, unbind, isBound, rebind, unbindAsync, onActivation, onDeactivation) => {
        ...
        bind(NxpodTableDescriptionProvider).toSelf().inSingletonScope();
        bind(TableDescriptionProvider).toService(NxpodTableDescriptionProvider);
