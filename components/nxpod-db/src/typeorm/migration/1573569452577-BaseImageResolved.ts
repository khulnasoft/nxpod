...
export class BaseImageResolved1573569452577 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`UPDATE d_b_workspace AS ws SET ws.baseImageNameResolved = ws.imageNameResolved WHERE ws.imageNameResolved NOT LIKE "eu.gcr.io/nxpod-dev/workspace-images%" AND ws.imageNameResolved != '' AND ws.baseImageNameResolved = ''`);
    }
