...
import { WorkspaceInstance, Workspace, PrebuiltWorkspace, CommitContext } from "@nxpod/nxpod-protocol";
...
class WorkspaceDBSpec {
    ...
    readonly ws: Workspace = {
        ...
        context: <CommitContext>{
            title: "example",
            repository: {
                cloneUrl: "https://github.com/khulnasoft/nxpod",
            },
            revision: "abc",
        },
    ...
    public async testCountUnabortedPrebuildsSince() {
        const now = new Date();
        const cloneURL = "https://github.com/khulnasoft/nxpod";
        const projectId = v4();
