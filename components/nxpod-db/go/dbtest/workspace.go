...
import (
	...
	"github.com/khulnasoft/nxpod/common-go/namegen"
...
func NewWorkspace(t *testing.T, workspace db.Workspace) db.Workspace {
	...
	contextURL := "https://github.com/khulnasoft/nxpod"
