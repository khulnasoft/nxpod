...
import (
	...
	"github.com/khulnasoft/nxpod/ws-proxy/pkg/sshproxy"
)
...
var runCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		go func() {
			...
			proxy.NewWorkspaceProxy(cfg.Ingress, cfg.Proxy, proxy.HostBasedRouter(cfg.Ingress.Header, cfg.Proxy.NxpodInstallation.WorkspaceHostSuffix, cfg.Proxy.NxpodInstallation.WorkspaceHostSuffixRegex), infoprov, sshGatewayServer).MustServe(ctrlCtx)
		}()
