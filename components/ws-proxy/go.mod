module github.com/khulnasoft/nxpod/ws-proxy
...
require (
	...
	github.com/khulnasoft/nxpod/content-service/api v0.0.0-00010101000000-000000000000 // indirect
...
replace github.com/khulnasoft/nxpod/ws-manager/api => ../ws-manager-api/go // leeway

replace github.com/khulnasoft/nxpod/server/go => ../server/go // leeway
