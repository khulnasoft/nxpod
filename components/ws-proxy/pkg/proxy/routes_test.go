	...
	tt := []handlerTest{
		...
		},
		{
			...
			req: testRequest{
				...
				headers: map[string]string{
					"Cookie": "_nxpod_io_=s%3Af2da2196-4afe-46e7-97b6-00eadfb4e373.KuHVEHhTuNln8RiegerwgSsAYF0LqwV5wI18tVeUNUw; ",
				},
			},
			targets: []proxyTarget{
				{
					...
					path: "/",
					handler: func(w http.ResponseWriter, req *http.Request) {
						hostnameSuffix := config.NxpodInstallation.HostName
		...
		},
		{
			...
			req: testRequest{
				...
				url:    "/",
				headers: map[string]string{
					"Origin":                        config.NxpodInstallation.HostName,
