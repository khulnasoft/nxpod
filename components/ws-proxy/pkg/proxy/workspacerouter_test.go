...
func TestWorkspaceRouter(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			URL:  "http://c65376da-3406-4cf3-a80b-99ce5f750235.ws.nxpod.dev/",
			Headers: map[string]string{
				forwardedHostnameHeader: "c65376da-3406-4cf3-a80b-99ce5f750235.ws.nxpod.dev",
			},
		...
		},
		{
			...
			URL:  "http://1234-c65376da-3406-4cf3-a80b-99ce5f750235.ws.nxpod.dev/",
			Headers: map[string]string{
				forwardedHostnameHeader: "1234-c65376da-3406-4cf3-a80b-99ce5f750235.ws.nxpod.dev",
			},
			Router:       HostBasedRouter(forwardedHostnameHeader, wsHostSuffix),
			WSHostSuffix: wsHostSuffix,
			Expected: Expectation{
		...
		},
		{
			...
			URL:  "http://8080-de5ce5ec-a9ac-49e4-aadc-4827d2dcb189.ws.nxpod.dev/",
			Headers: map[string]string{
				forwardedHostnameHeader: "8080-de5ce5ec-a9ac-49e4-aadc-4827d2dcb189.ws.nxpod.dev",
			},
			Router: PathAndHostRouter("/workspace/", forwardedHostnameHeader, wsHostSuffix),
			Infos: []WorkspaceInfo{
				{
