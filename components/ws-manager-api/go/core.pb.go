...
const (
	...
	// Imagebuild workspaces build a workspace, incl. their Nxpod layer. They run headless and have no direct user-interaction.
...
type MetadataFilter struct {
	...
	// owner is the ID of the Nxpod user to whom we'll bill this workspace and who we consider responsible for its content
...
type StartWorkspaceRequest struct {
	...
	// Metadata is data associated with this workspace that's required for other parts of Nxpod to function
