...
//+kubebuilder:webhook:path=/mutate-workspace-khulnasoft-v1-workspace,mutating=true,failurePolicy=fail,sideEffects=None,groups=workspace.nxpod.io,resources=workspaces,verbs=create;update,versions=v1,name=mworkspace.kb.io,admissionReviewVersions=v1
...
//+kubebuilder:webhook:path=/validate-workspace-khulnasoft-v1-workspace,mutating=false,failurePolicy=fail,sideEffects=None,groups=workspace.nxpod.io,resources=workspaces,verbs=create;update,versions=v1,name=vworkspace.kb.io,admissionReviewVersions=v1
