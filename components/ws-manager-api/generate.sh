...
mockgen \
    -package mock \
    github.com/khulnasoft/nxpod/ws-manager/api WorkspaceManager_SubscribeServer,WorkspaceManagerServer,WorkspaceManager_SubscribeClient,WorkspaceManagerClient > mock/mock.go
