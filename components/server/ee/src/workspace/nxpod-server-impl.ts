...
import { LicenseEvaluator, LicenseKeySource } from "@nxpod/licensor/lib";
...
@injectable()
export class NxpodServerEEImpl<C extends NxpodClient, S extends NxpodServer> extends NxpodServerImpl<C, S> {
