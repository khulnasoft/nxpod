...
import { TracedWorkspaceDB, DBWithTracing, TracedUserDB } from "@nxpod/nxpod-db/lib/traced-db";
import { WorkspaceDB } from "@nxpod/nxpod-db/lib/workspace-db";
import { TraceContext } from "@nxpod/nxpod-protocol/lib/util/tracing";
import { WorkspaceInstance, WorkspaceProbeContext, RunningWorkspaceInfo } from "@nxpod/nxpod-protocol";
import * as request from "request-promise";
import { log } from "@nxpod/nxpod-protocol/lib/util/logging";
import { URL } from "url";
import { WorkspaceFactory } from "../../../src/workspace/workspace-factory";
import { UserDB, BUILTIN_WORKSPACE_PROBE_USER_NAME } from "@nxpod/nxpod-db/lib/user-db";
...
export class WorkspaceHealthMonitoring {
    ...
    // probeAllRunningWorkspaces tries to reach /nxpod/ready on all workspaces currently running in this region
    ...
    protected async probeWorkspaceOnDifferentProbeURLs(ctx: TraceContext, wsi: WorkspaceInstance): Promise<ProbeResult> {
        ...
        primaryProbeURL.pathname = "/nxpod/ready";
