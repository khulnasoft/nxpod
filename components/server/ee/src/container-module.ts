...
import { NxpodServerEEImpl } from "./workspace/nxpod-server-impl";
...
import { LicenseDBImpl } from "@nxpod/nxpod-db/lib/typeorm/license-db-impl";
...
export const productionEEContainerModule = new ContainerModule((bind, unbind, isBound, rebind) => {
    ...
    rebind(NxpodServerImpl).to(NxpodServerEEImpl).inRequestScope();
