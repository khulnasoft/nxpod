...
describe('express-util', function() {
  describe('isAllowedWebsocketDomain', function() {
    it('should return false for workspace-port locations', function() {
      const result = isAllowedWebsocketDomain("http://3000-aee7da59-2b15-42a6-9773-2546ed487149.ws-eu.gpl-2732-ws-csrf.staging.nxpod.io", HOSTURL_HOSTNAME);
      expect(result).to.be.false;
    });

    it('should return true for workspace locations', function() {
      const result = isAllowedWebsocketDomain("http://aee7da59-2b15-42a6-9773-2546ed487149.ws-eu.gpl-2732-ws-csrf.staging.nxpod.io", HOSTURL_HOSTNAME);
