                ...
                return (...args: any[]) => {
                    ...
                    const handleError = (reason: unknown) => {
                        ...
                        if (
                            ...
                            // Compare https://linear.app/nxpod/issue/ENT-232 and https://github.com/khulnasoft/nxpod/pull/19827
                    ...
                    if (grpc_type === "unary" || grpc_type === "client_stream") {
                        return withRequestContext(async () => {
                            ...
                            if (
                                isCellDisabled &&
                                requestContext.requestMethod === "nxpod.v1.UserService/getAuthenticatedUser"
                            ) {
