...
export class ConfigurationService {
    ...
    async guessRepositoryConfiguration(
        ...
        return `# This configuration file was automatically generated by Nxpod.
# Please adjust to your needs (see https://www.nxpod.khulnasoft.com/docs/introduction/learn-nxpod/nxpod-yaml)
...
`;
    ...
    async fetchRepositoryConfiguration(
        ...
        const configString = await fileProvider.getNxpodFileContent(commitContext, user);
        return configString;
    }
