...
import { User, PullRequestContext, IssueContext, WorkspaceContext, Repository, CommitContext, WorkspaceProbeContext, WorkspaceConfig } from '@nxpod/nxpod-protocol';
import { Workspace, SnapshotContext } from '@nxpod/nxpod-protocol';
...
import { ImageBuilderClientProvider } from '@nxpod/image-builder/lib';
