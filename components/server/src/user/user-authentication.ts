...
import { isOrganizationOwned, isAllowedToCreateOrganization } from "@nxpod/public-api-common/lib/user-utils";
...
export class UserAuthentication {
    ...
    /**
     * nxpod.io: Only installation-level users are allowed to create orgs
