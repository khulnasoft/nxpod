...
export class UserController {
    ...
    @inject(NxpodCookie) protected readonly nxpodCookie: NxpodCookie;
    ...
    get apiRouter(): express.Router {
        ...
        router.get("/logout", (req: express.Request, res: express.Response, next: express.NextFunction) => {
            ...
            const redirect = () => {
                this.nxpodCookie.unsetCookie(res);
        ...
        router.get("/refresh-login", async (req: express.Request, res: express.Response, next: express.NextFunction) => {
            ...
            // Update `nxpod-user=loggedIn` as well
            this.nxpodCookie.setCookie(res);
        ...
        router.get("/auth/workspace-port/:port", async (req: express.Request, res: express.Response, next: express.NextFunction) => {
            ...
            const access = await this.workspacePortAuthService.authorizeWorkspacePortAccess(req.params.port, req.hostname, authenticatedUser, req.header("x-nxpod-port-auth"));
