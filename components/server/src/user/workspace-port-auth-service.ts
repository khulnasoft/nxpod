...
import { DescribeWorkspaceRequest, PortVisibility } from "@nxpod/ws-manager/lib";
import { worspacePortAuthCookieName as workspacePortAuthCookieName } from "@nxpod/nxpod-protocol/lib/util/workspace-port-authentication";
