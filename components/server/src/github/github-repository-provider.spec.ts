...
class TestGithubContextRepositoryProvider {
    ...
    static readonly AUTH_HOST_CONFIG: Partial<AuthProviderParams> = {
        ...
        host: "github.com",
        oauth: {
            callBackUrl: "https://nxpod.example.com/auth/github/callback",
        } as any,
    };
    ...
    @test public async testGetUserRepos() {
        ...
        expect(result).to.deep.include({ url: "https://github.com/nxpod-integration-test/example", name: "example" });
    }
}
