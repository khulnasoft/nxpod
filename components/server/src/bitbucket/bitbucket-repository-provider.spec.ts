...
class TestBitbucketRepositoryProvider {
    ...
    @test public async testGetRepo() {
        const result = await this.repoProvider.getRepo(this.user, "nxpod", "sample-repository");
        expect(result).to.deep.include({
            host: "bitbucket.org",
            owner: "nxpod",
            name: "sample-repository",
            cloneUrl: "https://nxpod@bitbucket.org/nxpod/sample-repository.git",
            description: "This is a sample repository.",
            webUrl: "https://bitbucket.org/nxpod/sample-repository",
        });
    }
