...
import { NavigatorContext, PullRequestContext, User, WorkspaceContext } from "@nxpod/nxpod-protocol";
...
import { AzureDevOpsOAuthScopes } from "@nxpod/public-api-common/lib/auth-providers";
...
export class AzureDevOpsContextParser extends AbstractContextParser implements IContextParser {
    ...
    // https://dev.azure.com/services-azure/test-project/_git/repo2?path=/.nxpod.yml&version=GBdevelop-2&_a=contents
    ...
    // https://dev.azure.com/services-azure/test-project/_git/repo2-fork?version=GTv0.0.1&path=/.nxpod.yml
    ...
    // https://dev.azure.com/services-azure/test-project/_git/repo2-fork/commit/4c47246a2eacd9700aab401902775c248e85aee7?refName=refs/heads/develop&path=/.nxpod.yml
