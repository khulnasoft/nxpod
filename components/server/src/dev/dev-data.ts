...
} from "@nxpod/public-api-common/lib/auth-providers";
...
export namespace DevData {
    ...
    export function createGitHubTestToken(): Token {
        if (!process.env.NXPOD_TEST_TOKEN_GITHUB) {
            console.error(
                `NXPOD_TEST_TOKEN_GITHUB env var is not set\n\n\t export NXPOD_TEST_TOKEN_GITHUB='{"username": "nxpod-test", "value": $GITHUB_TOKEN}'`,
            );
        }
        return {
    ...
    export function createAzureDevOpsTestToken(): Token {
        return {
            ...getTokenFromEnv("NXPOD_TEST_TOKEN_AZURE_DEVOPS"),
...
export namespace DevTestHelper {
    export const AzureTestEnv = "NXPOD_TEST_TOKEN_AZURE_DEVOPS";
