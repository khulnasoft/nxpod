...
# The goal here is to determine the set of tools that are available to us to install the necessary dependencies for nxpod into the image
...
case "$DISTRO" in
    ...
    "\"amzn\"")
        # Kreyren: Made for https://github.com/khulnasoft/nxpod/issues/1490
        DISTRO="amazon"
        ;;
