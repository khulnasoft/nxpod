...
mockgen \
    -package mock \
    github.com/khulnasoft/nxpod/image-builder/api ImageBuilderClient,ImageBuilder_BuildClient,ImageBuilder_LogsClient,ImageBuilderServer,ImageBuilder_BuildServer,ImageBuilder_LogsServer > mock/mock.go
