...
mv github.com/khulnasoft/nxpod/image-builder/api/* go
rm -rf github.com

GO111MODULE=on go get github.com/golang/mock/mockgen@latest
cd go
# source mode does not always work for gRPC: see https://github.com/golang/mock/pull/163
mockgen -package mock github.com/khulnasoft/nxpod/image-builder/api ImageBuilderClient,ImageBuilder_BuildClient,ImageBuilder_LogsClient > mock/mock.go
cd ..
