...
func TestToRef(t *testing.T) {
	tests := []struct {
		...
		{
			&api.ImageSpec{BaseRef: "eu.gcr.io/nxpod-dev/workspace-images:7b4b1621ce0a6f8d7b298add486f1e7f06735162a5b8143ad60c06348cafd5e4"},
			"registry-facade",
			"registry-facade/c/pmrgeyltmvpxezlgei5cezlvfztwg4ronfxs6z3joryg6zbnmrsxml3xn5zgw43qmfrwklljnvqwozlthi3wendcge3demldmuygcntghbsdoyrshe4gczdegq4dmzrrmu3wmmbwg4ztkmjwgjqtkyryge2dgylegyyggmbwgm2dqy3bmzsdkzjuej6q:latest",
			"",
		},
		{
			&api.ImageSpec{
				BaseRef:      "eu.gcr.io/nxpod-dev/workspace-images:7b4b1621ce0a6f8d7b298add486f1e7f06735162a5b8143ad60c06348cafd5e4",
		...
		{
			&api.ImageSpec{
				BaseRef:      "eu.gcr.io/nxpod-dev/workspace-images:7b4b1621ce0a6f8d7b298add486f1e7f06735162a5b8143ad60c06348cafd5e4THISISWAYTOOLONG7b4b1621ce0a6f8d7b298add486f1e7f06735162a5b8143ad60c06348cafd5e4",
