...
func (x *CellDisabledError) Reset() {
	*x = CellDisabledError{}
	if protoimpl.UnsafeEnabled {
		mi := &file_nxpod_v1_error_proto_msgTypes[11]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CellDisabledError) Descriptor() ([]byte, []int) {
	return file_nxpod_v1_error_proto_rawDescGZIP(), []int{11}
}
...
var file_nxpod_v1_error_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_nxpod_v1_error_proto_goTypes = []interface{}{
	...
	(*CellDisabledError)(nil),                  // 11: nxpod.v1.CellDisabledError
}
var file_nxpod_v1_error_proto_depIdxs = []int32{
	...
	11, // 9: nxpod.v1.FailedPreconditionDetails.cell_is_disabled:type_name -> nxpod.v1.CellDisabledError
...
func file_nxpod_v1_error_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_nxpod_v1_error_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
