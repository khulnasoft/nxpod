...
const (
	...
	TokenServiceName = "nxpod.v1.TokenService"
)

// TokenServiceClient is a client for the nxpod.v1.TokenService service.
...
// NewTokenServiceClient constructs a client for the nxpod.v1.TokenService service. By default, it
...
func NewTokenServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) TokenServiceClient {
	...
	return &tokenServiceClient{
		createTemporaryAccessToken: connect_go.NewClient[v1.CreateTemporaryAccessTokenRequest, v1.CreateTemporaryAccessTokenResponse](
			httpClient,
			baseURL+"/nxpod.v1.TokenService/CreateTemporaryAccessToken",
			opts...,
		),
	}
}
...
// CreateTemporaryAccessToken calls nxpod.v1.TokenService.CreateTemporaryAccessToken.
...
// TokenServiceHandler is an implementation of the nxpod.v1.TokenService service.
...
func NewTokenServiceHandler(svc TokenServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/nxpod.v1.TokenService/CreateTemporaryAccessToken", connect_go.NewUnaryHandler(
		"/nxpod.v1.TokenService/CreateTemporaryAccessToken",
		svc.CreateTemporaryAccessToken,
		opts...,
	))
	return "/nxpod.v1.TokenService/", mux
}
...
func (UnimplementedTokenServiceHandler) CreateTemporaryAccessToken(context.Context, *connect_go.Request[v1.CreateTemporaryAccessTokenRequest]) (*connect_go.Response[v1.CreateTemporaryAccessTokenResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("nxpod.v1.TokenService.CreateTemporaryAccessToken is not implemented"))
}
