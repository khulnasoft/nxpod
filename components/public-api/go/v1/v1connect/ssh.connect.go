...
const (
	...
	SSHServiceName = "nxpod.v1.SSHService"
)

// SSHServiceClient is a client for the nxpod.v1.SSHService service.
...
// NewSSHServiceClient constructs a client for the nxpod.v1.SSHService service. By default, it uses
...
// ListSSHPublicKeys calls nxpod.v1.SSHService.ListSSHPublicKeys.
...
// CreateSSHPublicKey calls nxpod.v1.SSHService.CreateSSHPublicKey.
...
// DeleteSSHPublicKey calls nxpod.v1.SSHService.DeleteSSHPublicKey.
...
// SSHServiceHandler is an implementation of the nxpod.v1.SSHService service.
...
func NewSSHServiceHandler(svc SSHServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/nxpod.v1.SSHService/ListSSHPublicKeys", connect_go.NewUnaryHandler(
		"/nxpod.v1.SSHService/ListSSHPublicKeys",
		svc.ListSSHPublicKeys,
		opts...,
	))
	mux.Handle("/nxpod.v1.SSHService/CreateSSHPublicKey", connect_go.NewUnaryHandler(
		"/nxpod.v1.SSHService/CreateSSHPublicKey",
		svc.CreateSSHPublicKey,
		opts...,
	))
	mux.Handle("/nxpod.v1.SSHService/DeleteSSHPublicKey", connect_go.NewUnaryHandler(
		"/nxpod.v1.SSHService/DeleteSSHPublicKey",
		svc.DeleteSSHPublicKey,
		opts...,
	))
	return "/nxpod.v1.SSHService/", mux
}
...
func (UnimplementedSSHServiceHandler) ListSSHPublicKeys(context.Context, *connect_go.Request[v1.ListSSHPublicKeysRequest]) (*connect_go.Response[v1.ListSSHPublicKeysResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("nxpod.v1.SSHService.ListSSHPublicKeys is not implemented"))
}
...
func (UnimplementedSSHServiceHandler) CreateSSHPublicKey(context.Context, *connect_go.Request[v1.CreateSSHPublicKeyRequest]) (*connect_go.Response[v1.CreateSSHPublicKeyResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("nxpod.v1.SSHService.CreateSSHPublicKey is not implemented"))
}
...
func (UnimplementedSSHServiceHandler) DeleteSSHPublicKey(context.Context, *connect_go.Request[v1.DeleteSSHPublicKeyRequest]) (*connect_go.Response[v1.DeleteSSHPublicKeyResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("nxpod.v1.SSHService.DeleteSSHPublicKey is not implemented"))
}
