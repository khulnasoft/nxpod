...
func (x *GetInstallationConfigurationRequest) Reset() {
	*x = GetInstallationConfigurationRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_nxpod_v1_installation_proto_msgTypes[17]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetInstallationConfigurationRequest) Descriptor() ([]byte, []int) {
	return file_nxpod_v1_installation_proto_rawDescGZIP(), []int{17}
}
...
func (x *GetInstallationConfigurationResponse) Reset() {
	*x = GetInstallationConfigurationResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_nxpod_v1_installation_proto_msgTypes[18]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetInstallationConfigurationResponse) Descriptor() ([]byte, []int) {
	return file_nxpod_v1_installation_proto_rawDescGZIP(), []int{18}
}
...
func (x *InstallationConfiguration) Reset() {
	*x = InstallationConfiguration{}
	if protoimpl.UnsafeEnabled {
		mi := &file_nxpod_v1_installation_proto_msgTypes[19]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*InstallationConfiguration) Descriptor() ([]byte, []int) {
	return file_nxpod_v1_installation_proto_rawDescGZIP(), []int{19}
}
...
var file_nxpod_v1_installation_proto_msgTypes = make([]protoimpl.MessageInfo, 20)
var file_nxpod_v1_installation_proto_goTypes = []interface{}{
	...
	(*GetInstallationConfigurationRequest)(nil),          // 17: nxpod.v1.GetInstallationConfigurationRequest
	(*GetInstallationConfigurationResponse)(nil),         // 18: nxpod.v1.GetInstallationConfigurationResponse
	(*InstallationConfiguration)(nil),                    // 19: nxpod.v1.InstallationConfiguration
	(*PaginationRequest)(nil),                            // 20: nxpod.v1.PaginationRequest
	(*Sort)(nil),                                         // 21: nxpod.v1.Sort
	(*PaginationResponse)(nil),                           // 22: nxpod.v1.PaginationResponse
...
var file_nxpod_v1_installation_proto_depIdxs = []int32{
	...
	20, // 1: nxpod.v1.ListBlockedRepositoriesRequest.pagination:type_name -> nxpod.v1.PaginationRequest
	21, // 2: nxpod.v1.ListBlockedRepositoriesRequest.sort:type_name -> nxpod.v1.Sort
	22, // 3: nxpod.v1.ListBlockedRepositoriesResponse.pagination:type_name -> nxpod.v1.PaginationResponse
	...
	20, // 6: nxpod.v1.ListBlockedEmailDomainsRequest.pagination:type_name -> nxpod.v1.PaginationRequest
	22, // 7: nxpod.v1.ListBlockedEmailDomainsResponse.pagination:type_name -> nxpod.v1.PaginationResponse
	...
	23, // 10: nxpod.v1.BlockedRepository.creation_time:type_name -> google.protobuf.Timestamp
	23, // 11: nxpod.v1.BlockedRepository.update_time:type_name -> google.protobuf.Timestamp
	19, // 12: nxpod.v1.GetInstallationConfigurationResponse.configuration:type_name -> nxpod.v1.InstallationConfiguration
	3,  // 13: nxpod.v1.InstallationService.GetInstallationWorkspaceDefaultImage:input_type -> nxpod.v1.GetInstallationWorkspaceDefaultImageRequest
	5,  // 14: nxpod.v1.InstallationService.ListBlockedRepositories:input_type -> nxpod.v1.ListBlockedRepositoriesRequest
	7,  // 15: nxpod.v1.InstallationService.CreateBlockedRepository:input_type -> nxpod.v1.CreateBlockedRepositoryRequest
	9,  // 16: nxpod.v1.InstallationService.DeleteBlockedRepository:input_type -> nxpod.v1.DeleteBlockedRepositoryRequest
	11, // 17: nxpod.v1.InstallationService.ListBlockedEmailDomains:input_type -> nxpod.v1.ListBlockedEmailDomainsRequest
	13, // 18: nxpod.v1.InstallationService.CreateBlockedEmailDomain:input_type -> nxpod.v1.CreateBlockedEmailDomainRequest
	0,  // 19: nxpod.v1.InstallationService.GetOnboardingState:input_type -> nxpod.v1.GetOnboardingStateRequest
	17, // 20: nxpod.v1.InstallationService.GetInstallationConfiguration:input_type -> nxpod.v1.GetInstallationConfigurationRequest
	4,  // 21: nxpod.v1.InstallationService.GetInstallationWorkspaceDefaultImage:output_type -> nxpod.v1.GetInstallationWorkspaceDefaultImageResponse
	6,  // 22: nxpod.v1.InstallationService.ListBlockedRepositories:output_type -> nxpod.v1.ListBlockedRepositoriesResponse
	8,  // 23: nxpod.v1.InstallationService.CreateBlockedRepository:output_type -> nxpod.v1.CreateBlockedRepositoryResponse
	10, // 24: nxpod.v1.InstallationService.DeleteBlockedRepository:output_type -> nxpod.v1.DeleteBlockedRepositoryResponse
	12, // 25: nxpod.v1.InstallationService.ListBlockedEmailDomains:output_type -> nxpod.v1.ListBlockedEmailDomainsResponse
	14, // 26: nxpod.v1.InstallationService.CreateBlockedEmailDomain:output_type -> nxpod.v1.CreateBlockedEmailDomainResponse
	1,  // 27: nxpod.v1.InstallationService.GetOnboardingState:output_type -> nxpod.v1.GetOnboardingStateResponse
	18, // 28: nxpod.v1.InstallationService.GetInstallationConfiguration:output_type -> nxpod.v1.GetInstallationConfigurationResponse
...
func file_nxpod_v1_installation_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_nxpod_v1_installation_proto_msgTypes[17].Exporter = func(v interface{}, i int) interface{} {
		...
		file_nxpod_v1_installation_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
		...
		file_nxpod_v1_installation_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
