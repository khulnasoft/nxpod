...
const (
	...
	HelloServiceName = "nxpod.experimental.v1.HelloService"
)

// HelloServiceClient is a client for the nxpod.experimental.v1.HelloService service.
...
// NewHelloServiceClient constructs a client for the nxpod.experimental.v1.HelloService service. By
...
func NewHelloServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) HelloServiceClient {
	...
	return &helloServiceClient{
		sayHello: connect_go.NewClient[v1.SayHelloRequest, v1.SayHelloResponse](
			httpClient,
			baseURL+"/nxpod.experimental.v1.HelloService/SayHello",
			opts...,
		),
		lotsOfReplies: connect_go.NewClient[v1.LotsOfRepliesRequest, v1.LotsOfRepliesResponse](
			httpClient,
			baseURL+"/nxpod.experimental.v1.HelloService/LotsOfReplies",
			opts...,
		),
	}
}
...
// SayHello calls nxpod.experimental.v1.HelloService.SayHello.
...
// LotsOfReplies calls nxpod.experimental.v1.HelloService.LotsOfReplies.
...
// HelloServiceHandler is an implementation of the nxpod.experimental.v1.HelloService service.
...
func NewHelloServiceHandler(svc HelloServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/nxpod.experimental.v1.HelloService/SayHello", connect_go.NewUnaryHandler(
		"/nxpod.experimental.v1.HelloService/SayHello",
		svc.SayHello,
		opts...,
	))
	mux.Handle("/nxpod.experimental.v1.HelloService/LotsOfReplies", connect_go.NewServerStreamHandler(
		"/nxpod.experimental.v1.HelloService/LotsOfReplies",
		svc.LotsOfReplies,
		opts...,
	))
	return "/nxpod.experimental.v1.HelloService/", mux
}
...
func (UnimplementedHelloServiceHandler) SayHello(context.Context, *connect_go.Request[v1.SayHelloRequest]) (*connect_go.Response[v1.SayHelloResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("nxpod.experimental.v1.HelloService.SayHello is not implemented"))
}
...
func (UnimplementedHelloServiceHandler) LotsOfReplies(context.Context, *connect_go.Request[v1.LotsOfRepliesRequest], *connect_go.ServerStream[v1.LotsOfRepliesResponse]) error {
	return connect_go.NewError(connect_go.CodeUnimplemented, errors.New("nxpod.experimental.v1.HelloService.LotsOfReplies is not implemented"))
}
