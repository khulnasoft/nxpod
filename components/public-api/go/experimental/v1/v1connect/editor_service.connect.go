...
const (
	...
	EditorServiceName = "nxpod.experimental.v1.EditorService"
)

// EditorServiceClient is a client for the nxpod.experimental.v1.EditorService service.
...
// NewEditorServiceClient constructs a client for the nxpod.experimental.v1.EditorService service.
...
func NewEditorServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) EditorServiceClient {
	...
	return &editorServiceClient{
		listEditorOptions: connect_go.NewClient[v1.ListEditorOptionsRequest, v1.ListEditorOptionsResponse](
			httpClient,
			baseURL+"/nxpod.experimental.v1.EditorService/ListEditorOptions",
			opts...,
		),
	}
}
...
// ListEditorOptions calls nxpod.experimental.v1.EditorService.ListEditorOptions.
...
// EditorServiceHandler is an implementation of the nxpod.experimental.v1.EditorService service.
...
func NewEditorServiceHandler(svc EditorServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/nxpod.experimental.v1.EditorService/ListEditorOptions", connect_go.NewUnaryHandler(
		"/nxpod.experimental.v1.EditorService/ListEditorOptions",
		svc.ListEditorOptions,
		opts...,
	))
	return "/nxpod.experimental.v1.EditorService/", mux
}
...
func (UnimplementedEditorServiceHandler) ListEditorOptions(context.Context, *connect_go.Request[v1.ListEditorOptionsRequest]) (*connect_go.Response[v1.ListEditorOptionsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("nxpod.experimental.v1.EditorService.ListEditorOptions is not implemented"))
}
