...
const (
	...
	UserServiceName = "nxpod.experimental.v1.UserService"
)

// UserServiceClient is a client for the nxpod.experimental.v1.UserService service.
...
// NewUserServiceClient constructs a client for the nxpod.experimental.v1.UserService service. By
...
// GetAuthenticatedUser calls nxpod.experimental.v1.UserService.GetAuthenticatedUser.
...
// ListSSHKeys calls nxpod.experimental.v1.UserService.ListSSHKeys.
...
// CreateSSHKey calls nxpod.experimental.v1.UserService.CreateSSHKey.
...
// GetSSHKey calls nxpod.experimental.v1.UserService.GetSSHKey.
...
// DeleteSSHKey calls nxpod.experimental.v1.UserService.DeleteSSHKey.
...
// GetGitToken calls nxpod.experimental.v1.UserService.GetGitToken.
...
// BlockUser calls nxpod.experimental.v1.UserService.BlockUser.
...
// UserServiceHandler is an implementation of the nxpod.experimental.v1.UserService service.
...
func NewUserServiceHandler(svc UserServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/nxpod.experimental.v1.UserService/GetAuthenticatedUser", connect_go.NewUnaryHandler(
		"/nxpod.experimental.v1.UserService/GetAuthenticatedUser",
		svc.GetAuthenticatedUser,
		opts...,
	))
	mux.Handle("/nxpod.experimental.v1.UserService/ListSSHKeys", connect_go.NewUnaryHandler(
		"/nxpod.experimental.v1.UserService/ListSSHKeys",
		svc.ListSSHKeys,
		opts...,
	))
	mux.Handle("/nxpod.experimental.v1.UserService/CreateSSHKey", connect_go.NewUnaryHandler(
		"/nxpod.experimental.v1.UserService/CreateSSHKey",
		svc.CreateSSHKey,
		opts...,
	))
	mux.Handle("/nxpod.experimental.v1.UserService/GetSSHKey", connect_go.NewUnaryHandler(
		"/nxpod.experimental.v1.UserService/GetSSHKey",
		svc.GetSSHKey,
		opts...,
	))
	mux.Handle("/nxpod.experimental.v1.UserService/DeleteSSHKey", connect_go.NewUnaryHandler(
		"/nxpod.experimental.v1.UserService/DeleteSSHKey",
		svc.DeleteSSHKey,
		opts...,
	))
	mux.Handle("/nxpod.experimental.v1.UserService/GetGitToken", connect_go.NewUnaryHandler(
		"/nxpod.experimental.v1.UserService/GetGitToken",
		svc.GetGitToken,
		opts...,
	))
	mux.Handle("/nxpod.experimental.v1.UserService/BlockUser", connect_go.NewUnaryHandler(
		"/nxpod.experimental.v1.UserService/BlockUser",
		svc.BlockUser,
		opts...,
	))
	return "/nxpod.experimental.v1.UserService/", mux
}
...
func (UnimplementedUserServiceHandler) GetAuthenticatedUser(context.Context, *connect_go.Request[v1.GetAuthenticatedUserRequest]) (*connect_go.Response[v1.GetAuthenticatedUserResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("nxpod.experimental.v1.UserService.GetAuthenticatedUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) ListSSHKeys(context.Context, *connect_go.Request[v1.ListSSHKeysRequest]) (*connect_go.Response[v1.ListSSHKeysResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("nxpod.experimental.v1.UserService.ListSSHKeys is not implemented"))
}
...
func (UnimplementedUserServiceHandler) CreateSSHKey(context.Context, *connect_go.Request[v1.CreateSSHKeyRequest]) (*connect_go.Response[v1.CreateSSHKeyResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("nxpod.experimental.v1.UserService.CreateSSHKey is not implemented"))
}
...
func (UnimplementedUserServiceHandler) GetSSHKey(context.Context, *connect_go.Request[v1.GetSSHKeyRequest]) (*connect_go.Response[v1.GetSSHKeyResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("nxpod.experimental.v1.UserService.GetSSHKey is not implemented"))
}
...
func (UnimplementedUserServiceHandler) DeleteSSHKey(context.Context, *connect_go.Request[v1.DeleteSSHKeyRequest]) (*connect_go.Response[v1.DeleteSSHKeyResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("nxpod.experimental.v1.UserService.DeleteSSHKey is not implemented"))
}
...
func (UnimplementedUserServiceHandler) GetGitToken(context.Context, *connect_go.Request[v1.GetGitTokenRequest]) (*connect_go.Response[v1.GetGitTokenResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("nxpod.experimental.v1.UserService.GetGitToken is not implemented"))
}
...
func (UnimplementedUserServiceHandler) BlockUser(context.Context, *connect_go.Request[v1.BlockUserRequest]) (*connect_go.Response[v1.BlockUserResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("nxpod.experimental.v1.UserService.BlockUser is not implemented"))
}
