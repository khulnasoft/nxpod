...
const (
	...
	TokensServiceName = "nxpod.experimental.v1.TokensService"
)

// TokensServiceClient is a client for the nxpod.experimental.v1.TokensService service.
...
// NewTokensServiceClient constructs a client for the nxpod.experimental.v1.TokensService service.
...
// CreatePersonalAccessToken calls nxpod.experimental.v1.TokensService.CreatePersonalAccessToken.
...
// GetPersonalAccessToken calls nxpod.experimental.v1.TokensService.GetPersonalAccessToken.
...
// ListPersonalAccessTokens calls nxpod.experimental.v1.TokensService.ListPersonalAccessTokens.
...
// nxpod.experimental.v1.TokensService.RegeneratePersonalAccessToken.
...
// UpdatePersonalAccessToken calls nxpod.experimental.v1.TokensService.UpdatePersonalAccessToken.
...
// DeletePersonalAccessToken calls nxpod.experimental.v1.TokensService.DeletePersonalAccessToken.
...
// TokensServiceHandler is an implementation of the nxpod.experimental.v1.TokensService service.
...
func NewTokensServiceHandler(svc TokensServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/nxpod.experimental.v1.TokensService/CreatePersonalAccessToken", connect_go.NewUnaryHandler(
		"/nxpod.experimental.v1.TokensService/CreatePersonalAccessToken",
		svc.CreatePersonalAccessToken,
		opts...,
	))
	mux.Handle("/nxpod.experimental.v1.TokensService/GetPersonalAccessToken", connect_go.NewUnaryHandler(
		"/nxpod.experimental.v1.TokensService/GetPersonalAccessToken",
		svc.GetPersonalAccessToken,
		opts...,
	))
	mux.Handle("/nxpod.experimental.v1.TokensService/ListPersonalAccessTokens", connect_go.NewUnaryHandler(
		"/nxpod.experimental.v1.TokensService/ListPersonalAccessTokens",
		svc.ListPersonalAccessTokens,
		opts...,
	))
	mux.Handle("/nxpod.experimental.v1.TokensService/RegeneratePersonalAccessToken", connect_go.NewUnaryHandler(
		"/nxpod.experimental.v1.TokensService/RegeneratePersonalAccessToken",
		svc.RegeneratePersonalAccessToken,
		opts...,
	))
	mux.Handle("/nxpod.experimental.v1.TokensService/UpdatePersonalAccessToken", connect_go.NewUnaryHandler(
		"/nxpod.experimental.v1.TokensService/UpdatePersonalAccessToken",
		svc.UpdatePersonalAccessToken,
		opts...,
	))
	mux.Handle("/nxpod.experimental.v1.TokensService/DeletePersonalAccessToken", connect_go.NewUnaryHandler(
		"/nxpod.experimental.v1.TokensService/DeletePersonalAccessToken",
		svc.DeletePersonalAccessToken,
		opts...,
	))
	return "/nxpod.experimental.v1.TokensService/", mux
}
...
func (UnimplementedTokensServiceHandler) CreatePersonalAccessToken(context.Context, *connect_go.Request[v1.CreatePersonalAccessTokenRequest]) (*connect_go.Response[v1.CreatePersonalAccessTokenResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("nxpod.experimental.v1.TokensService.CreatePersonalAccessToken is not implemented"))
}
...
func (UnimplementedTokensServiceHandler) GetPersonalAccessToken(context.Context, *connect_go.Request[v1.GetPersonalAccessTokenRequest]) (*connect_go.Response[v1.GetPersonalAccessTokenResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("nxpod.experimental.v1.TokensService.GetPersonalAccessToken is not implemented"))
}
...
func (UnimplementedTokensServiceHandler) ListPersonalAccessTokens(context.Context, *connect_go.Request[v1.ListPersonalAccessTokensRequest]) (*connect_go.Response[v1.ListPersonalAccessTokensResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("nxpod.experimental.v1.TokensService.ListPersonalAccessTokens is not implemented"))
}
...
func (UnimplementedTokensServiceHandler) RegeneratePersonalAccessToken(context.Context, *connect_go.Request[v1.RegeneratePersonalAccessTokenRequest]) (*connect_go.Response[v1.RegeneratePersonalAccessTokenResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("nxpod.experimental.v1.TokensService.RegeneratePersonalAccessToken is not implemented"))
}
...
func (UnimplementedTokensServiceHandler) UpdatePersonalAccessToken(context.Context, *connect_go.Request[v1.UpdatePersonalAccessTokenRequest]) (*connect_go.Response[v1.UpdatePersonalAccessTokenResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("nxpod.experimental.v1.TokensService.UpdatePersonalAccessToken is not implemented"))
}
...
func (UnimplementedTokensServiceHandler) DeletePersonalAccessToken(context.Context, *connect_go.Request[v1.DeletePersonalAccessTokenRequest]) (*connect_go.Response[v1.DeletePersonalAccessTokenResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("nxpod.experimental.v1.TokensService.DeletePersonalAccessToken is not implemented"))
}
