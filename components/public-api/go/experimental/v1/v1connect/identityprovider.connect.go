...
const (
	...
	IdentityProviderServiceName = "nxpod.experimental.v1.IdentityProviderService"
)

// IdentityProviderServiceClient is a client for the nxpod.experimental.v1.IdentityProviderService
// service.
...
// nxpod.experimental.v1.IdentityProviderService service. By default, it uses the Connect protocol
...
func NewIdentityProviderServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) IdentityProviderServiceClient {
	...
	return &identityProviderServiceClient{
		getIDToken: connect_go.NewClient[v1.GetIDTokenRequest, v1.GetIDTokenResponse](
			httpClient,
			baseURL+"/nxpod.experimental.v1.IdentityProviderService/GetIDToken",
			opts...,
		),
	}
}
...
// GetIDToken calls nxpod.experimental.v1.IdentityProviderService.GetIDToken.
...
// nxpod.experimental.v1.IdentityProviderService service.
...
func NewIdentityProviderServiceHandler(svc IdentityProviderServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/nxpod.experimental.v1.IdentityProviderService/GetIDToken", connect_go.NewUnaryHandler(
		"/nxpod.experimental.v1.IdentityProviderService/GetIDToken",
		svc.GetIDToken,
		opts...,
	))
	return "/nxpod.experimental.v1.IdentityProviderService/", mux
}
...
func (UnimplementedIdentityProviderServiceHandler) GetIDToken(context.Context, *connect_go.Request[v1.GetIDTokenRequest]) (*connect_go.Response[v1.GetIDTokenResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("nxpod.experimental.v1.IdentityProviderService.GetIDToken is not implemented"))
}
