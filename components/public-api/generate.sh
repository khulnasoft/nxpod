...
pushd "go"
  go install github.com/khulnasoft/nxpod/components/public-api/go/protoc-proxy-gen
popd
...
buf breaking --against "https://github.com/khulnasoft/nxpod.git#branch=main,subdir=components/public-api"
