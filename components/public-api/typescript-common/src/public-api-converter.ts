...
import {
    ...
    Configuration as NxpodServerInstallationConfiguration,
...
export class PublicAPIConverter {
    ...
    toPrebuildStatus(nxpodHost: string, prebuild: PrebuildWithStatus): PrebuildStatus {
        ...
        // This is a hack mimicking the supervisor behavior of adding dynamic IDE tasks https://github.com/khulnasoft/nxpod/blob/e7d79c355e2cd6ac34056ea52d7bdcda45975839/components/ide-service/pkg/server/server.go#L508-L540
    ...
    toInstallationConfiguration(config: NxpodServerInstallationConfiguration): InstallationConfiguration {
