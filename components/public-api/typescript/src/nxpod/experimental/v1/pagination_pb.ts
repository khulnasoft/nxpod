...
// @generated from file nxpod/experimental/v1/pagination.proto (package nxpod.experimental.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from message nxpod.experimental.v1.Pagination
 */
export class Pagination extends Message<Pagination> {
  ...
  static readonly typeName = "nxpod.experimental.v1.Pagination";
