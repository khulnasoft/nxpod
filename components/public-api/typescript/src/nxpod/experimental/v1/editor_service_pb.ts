...
/**
 * @generated from message nxpod.experimental.v1.ListEditorOptionsRequest
 */
export class ListEditorOptionsRequest extends Message<ListEditorOptionsRequest> {
  ...
  static readonly typeName = "nxpod.experimental.v1.ListEditorOptionsRequest";
...
/**
 * @generated from message nxpod.experimental.v1.ListEditorOptionsResponse
 */
export class ListEditorOptionsResponse extends Message<ListEditorOptionsResponse> {
  /**
   * @generated from field: repeated nxpod.experimental.v1.EditorOption result = 1;
   */
  result: EditorOption[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "nxpod.experimental.v1.ListEditorOptionsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message nxpod.experimental.v1.EditorOption
 */
export class EditorOption extends Message<EditorOption> {
  ...
  /**
   * @generated from field: nxpod.experimental.v1.EditorOption.Type type = 3;
   */
  ...
  /**
   * @generated from field: nxpod.experimental.v1.EditorOption.Kind stable = 6;
   */
  stable?: EditorOption_Kind;

  /**
   * @generated from field: nxpod.experimental.v1.EditorOption.Kind latest = 7;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "nxpod.experimental.v1.EditorOption";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from enum nxpod.experimental.v1.EditorOption.Type
 */
...
proto3.util.setEnumType(EditorOption_Type, "nxpod.experimental.v1.EditorOption.Type", [
...
/**
 * @generated from message nxpod.experimental.v1.EditorOption.Kind
 */
export class EditorOption_Kind extends Message<EditorOption_Kind> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "nxpod.experimental.v1.EditorOption.Kind";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
