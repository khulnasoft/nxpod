...
/**
 * @generated from message nxpod.experimental.v1.Project
 */
export class Project extends Message<Project> {
   ...
   *
   * @generated from field: nxpod.experimental.v1.ProjectSettings settings = 8;
   */
  ...
  static readonly typeName = "nxpod.experimental.v1.Project";
...
/**
 * @generated from message nxpod.experimental.v1.ProjectSettings
 */
export class ProjectSettings extends Message<ProjectSettings> {
  /**
   * @generated from field: nxpod.experimental.v1.PrebuildSettings prebuild = 1;
   */
  prebuild?: PrebuildSettings;

  /**
   * @generated from field: nxpod.experimental.v1.WorkspaceSettings workspace = 2;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "nxpod.experimental.v1.ProjectSettings";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message nxpod.experimental.v1.PrebuildSettings
 */
export class PrebuildSettings extends Message<PrebuildSettings> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "nxpod.experimental.v1.PrebuildSettings";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message nxpod.experimental.v1.WorkspaceSettings
 */
export class WorkspaceSettings extends Message<WorkspaceSettings> {
  ...
  /**
   * @generated from field: nxpod.experimental.v1.WorkspaceClassSettings workspace_class = 2;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "nxpod.experimental.v1.WorkspaceSettings";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message nxpod.experimental.v1.WorkspaceClassSettings
 */
export class WorkspaceClassSettings extends Message<WorkspaceClassSettings> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "nxpod.experimental.v1.WorkspaceClassSettings";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message nxpod.experimental.v1.CreateProjectRequest
 */
export class CreateProjectRequest extends Message<CreateProjectRequest> {
  /**
   * @generated from field: nxpod.experimental.v1.Project project = 1;
   */
  project?: Project;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "nxpod.experimental.v1.CreateProjectRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message nxpod.experimental.v1.CreateProjectResponse
 */
export class CreateProjectResponse extends Message<CreateProjectResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "nxpod.experimental.v1.CreateProjectResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "project", kind: "message", T: Project },
  ]);
...
/**
 * @generated from message nxpod.experimental.v1.GetProjectRequest
 */
export class GetProjectRequest extends Message<GetProjectRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "nxpod.experimental.v1.GetProjectRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message nxpod.experimental.v1.GetProjectResponse
 */
export class GetProjectResponse extends Message<GetProjectResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "nxpod.experimental.v1.GetProjectResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "project", kind: "message", T: Project },
  ]);
...
/**
 * @generated from message nxpod.experimental.v1.ListProjectsRequest
 */
export class ListProjectsRequest extends Message<ListProjectsRequest> {
   ...
   * Page information
   *
   * @generated from field: nxpod.experimental.v1.Pagination pagination = 3;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "nxpod.experimental.v1.ListProjectsRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 2, name: "team_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message nxpod.experimental.v1.ListProjectsResponse
 */
export class ListProjectsResponse extends Message<ListProjectsResponse> {
  /**
   * @generated from field: repeated nxpod.experimental.v1.Project projects = 1;
   */
  projects: Project[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "nxpod.experimental.v1.ListProjectsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message nxpod.experimental.v1.DeleteProjectRequest
 */
export class DeleteProjectRequest extends Message<DeleteProjectRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "nxpod.experimental.v1.DeleteProjectRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "project_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
...
/**
 * @generated from message nxpod.experimental.v1.DeleteProjectResponse
 */
export class DeleteProjectResponse extends Message<DeleteProjectResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "nxpod.experimental.v1.DeleteProjectResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
