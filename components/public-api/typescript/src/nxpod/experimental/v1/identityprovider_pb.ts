...
/**
 * @generated from message nxpod.experimental.v1.GetIDTokenRequest
 */
export class GetIDTokenRequest extends Message<GetIDTokenRequest> {
  ...
  static readonly typeName = "nxpod.experimental.v1.GetIDTokenRequest";
...
/**
 * @generated from message nxpod.experimental.v1.GetIDTokenResponse
 */
export class GetIDTokenResponse extends Message<GetIDTokenResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "nxpod.experimental.v1.GetIDTokenResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
