 ...
 * testing.
 *
 * @generated from service nxpod.experimental.v1.HelloService
 */
export const HelloService = {
  typeName: "nxpod.experimental.v1.HelloService",
  methods: {
    /**
     ...
     *
     * @generated from rpc nxpod.experimental.v1.HelloService.SayHello
     */
    sayHello: {
      name: "SayHello",
      I: SayHelloRequest,
     ...
     *
     * @generated from rpc nxpod.experimental.v1.HelloService.LotsOfReplies
     */
    lotsOfReplies: {
      name: "LotsOfReplies",
