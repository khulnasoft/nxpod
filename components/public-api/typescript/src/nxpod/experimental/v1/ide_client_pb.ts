...
/**
 * @generated from message nxpod.experimental.v1.SendHeartbeatRequest
 */
export class SendHeartbeatRequest extends Message<SendHeartbeatRequest> {
  ...
  static readonly typeName = "nxpod.experimental.v1.SendHeartbeatRequest";
...
/**
 * @generated from message nxpod.experimental.v1.SendHeartbeatResponse
 */
export class SendHeartbeatResponse extends Message<SendHeartbeatResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "nxpod.experimental.v1.SendHeartbeatResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
/**
 * @generated from message nxpod.experimental.v1.SendDidCloseRequest
 */
export class SendDidCloseRequest extends Message<SendDidCloseRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "nxpod.experimental.v1.SendDidCloseRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "workspace_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
...
/**
 * @generated from message nxpod.experimental.v1.SendDidCloseResponse
 */
export class SendDidCloseResponse extends Message<SendDidCloseResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "nxpod.experimental.v1.SendDidCloseResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
/**
 * @generated from message nxpod.experimental.v1.UpdateGitStatusRequest
 */
export class UpdateGitStatusRequest extends Message<UpdateGitStatusRequest> {
  ...
  /**
   * @generated from field: nxpod.experimental.v1.GitStatus status = 2;
   */
  status?: GitStatus;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "nxpod.experimental.v1.UpdateGitStatusRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "workspace_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message nxpod.experimental.v1.UpdateGitStatusResponse
 */
export class UpdateGitStatusResponse extends Message<UpdateGitStatusResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "nxpod.experimental.v1.UpdateGitStatusResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
