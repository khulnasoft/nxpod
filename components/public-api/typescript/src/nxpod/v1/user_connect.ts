...
/**
 * @generated from service nxpod.v1.UserService
 */
export const UserService = {
  typeName: "nxpod.v1.UserService",
  methods: {
    /**
     * GetAuthenticatedUser allows to retrieve the current user.
     *
     * @generated from rpc nxpod.v1.UserService.GetAuthenticatedUser
     */
     ...
     *
     * @generated from rpc nxpod.v1.UserService.UpdateUser
     */
    updateUser: {
      name: "UpdateUser",
      I: UpdateUserRequest,
     ...
     *
     * @generated from rpc nxpod.v1.UserService.SetWorkspaceAutoStartOptions
     */
     ...
     *
     * @generated from rpc nxpod.v1.UserService.DeleteUser
     */
    deleteUser: {
      name: "DeleteUser",
      I: DeleteUserRequest,
     ...
     *
     * @generated from rpc nxpod.v1.UserService.VerifyUser
     */
    verifyUser: {
      name: "VerifyUser",
      I: VerifyUserRequest,
     ...
     * +admin – only to be used by installation admins
     *
     * @generated from rpc nxpod.v1.UserService.BlockUser
     */
    blockUser: {
      name: "BlockUser",
      I: BlockUserRequest,
     ...
     * +admin – only to be used by installation admins
     *
     * @generated from rpc nxpod.v1.UserService.ListUsers
     */
    listUsers: {
      name: "ListUsers",
      I: ListUsersRequest,
     ...
     * +admin – only to be used by installation admins
     *
     * @generated from rpc nxpod.v1.UserService.GetUser
     */
    getUser: {
      name: "GetUser",
      I: GetUserRequest,
     ...
     * +admin – only to be used by installation admins
     *
     * @generated from rpc nxpod.v1.UserService.SetRolesOrPermissions
     */
