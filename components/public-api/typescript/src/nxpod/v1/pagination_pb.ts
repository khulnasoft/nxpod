...
// @generated from file nxpod/v1/pagination.proto (package nxpod.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from message nxpod.v1.PaginationRequest
 */
export class PaginationRequest extends Message<PaginationRequest> {
  ...
  static readonly typeName = "nxpod.v1.PaginationRequest";
...
/**
 * @generated from message nxpod.v1.PaginationResponse
 */
export class PaginationResponse extends Message<PaginationResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "nxpod.v1.PaginationResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
