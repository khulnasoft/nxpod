...
/**
 * @generated from service nxpod.v1.VerificationService
 */
export const VerificationService = {
  typeName: "nxpod.v1.VerificationService",
  methods: {
    /**
     * SendPhoneNumberVerificationToken sends a verification token to the
     * specified phone number.
     *
     * @generated from rpc nxpod.v1.VerificationService.SendPhoneNumberVerificationToken
     */
     ...
     * token.
     *
     * @generated from rpc nxpod.v1.VerificationService.VerifyPhoneNumberVerificationToken
     */
