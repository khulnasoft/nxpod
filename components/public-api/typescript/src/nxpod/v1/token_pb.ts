...
/**
 * @generated from message nxpod.v1.CreateTemporaryAccessTokenRequest
 */
export class CreateTemporaryAccessTokenRequest extends Message<CreateTemporaryAccessTokenRequest> {
  ...
  static readonly typeName = "nxpod.v1.CreateTemporaryAccessTokenRequest";
...
/**
 * @generated from message nxpod.v1.CreateTemporaryAccessTokenResponse
 */
export class CreateTemporaryAccessTokenResponse extends Message<CreateTemporaryAccessTokenResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "nxpod.v1.CreateTemporaryAccessTokenResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
