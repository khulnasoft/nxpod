...
/**
 * @generated from service nxpod.v1.SCMService
 */
export const SCMService = {
  typeName: "nxpod.v1.SCMService",
  methods: {
    /**
     * SearchSCMTokens allows clients to retrieve SCM tokens based on the
     * specified host.
     *
     * @generated from rpc nxpod.v1.SCMService.SearchSCMTokens
     */
    searchSCMTokens: {
     ...
     *
     * @generated from rpc nxpod.v1.SCMService.GuessTokenScopes
     */
    guessTokenScopes: {
     ...
     *
     * @generated from rpc nxpod.v1.SCMService.SearchRepositories
     */
    searchRepositories: {
     ...
     *
     * @generated from rpc nxpod.v1.SCMService.ListSuggestedRepositories
     */
