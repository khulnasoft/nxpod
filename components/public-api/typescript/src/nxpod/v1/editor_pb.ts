...
// @generated from file nxpod/v1/editor.proto (package nxpod.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from message nxpod.v1.EditorReference
 */
export class EditorReference extends Message<EditorReference> {
  ...
  static readonly typeName = "nxpod.v1.EditorReference";
