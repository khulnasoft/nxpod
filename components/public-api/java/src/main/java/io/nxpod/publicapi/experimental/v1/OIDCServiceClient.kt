...
public class OIDCServiceClient(
  ...
  override suspend fun createClientConfig(request: Oidc.CreateClientConfigRequest,
    ...
    "nxpod.experimental.v1.OIDCService/CreateClientConfig",
      io.nxpod.publicapi.experimental.v1.Oidc.CreateClientConfigRequest::class,
      io.nxpod.publicapi.experimental.v1.Oidc.CreateClientConfigResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun getClientConfig(request: Oidc.GetClientConfigRequest, headers: Headers):
    ...
    "nxpod.experimental.v1.OIDCService/GetClientConfig",
      io.nxpod.publicapi.experimental.v1.Oidc.GetClientConfigRequest::class,
      io.nxpod.publicapi.experimental.v1.Oidc.GetClientConfigResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun listClientConfigs(request: Oidc.ListClientConfigsRequest, headers: Headers):
    ...
    "nxpod.experimental.v1.OIDCService/ListClientConfigs",
      io.nxpod.publicapi.experimental.v1.Oidc.ListClientConfigsRequest::class,
      io.nxpod.publicapi.experimental.v1.Oidc.ListClientConfigsResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun updateClientConfig(request: Oidc.UpdateClientConfigRequest,
    ...
    "nxpod.experimental.v1.OIDCService/UpdateClientConfig",
      io.nxpod.publicapi.experimental.v1.Oidc.UpdateClientConfigRequest::class,
      io.nxpod.publicapi.experimental.v1.Oidc.UpdateClientConfigResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun deleteClientConfig(request: Oidc.DeleteClientConfigRequest,
    ...
    "nxpod.experimental.v1.OIDCService/DeleteClientConfig",
      io.nxpod.publicapi.experimental.v1.Oidc.DeleteClientConfigRequest::class,
      io.nxpod.publicapi.experimental.v1.Oidc.DeleteClientConfigResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun setClientConfigActivation(request: Oidc.SetClientConfigActivationRequest,
    ...
    "nxpod.experimental.v1.OIDCService/SetClientConfigActivation",
      io.nxpod.publicapi.experimental.v1.Oidc.SetClientConfigActivationRequest::class,
      io.nxpod.publicapi.experimental.v1.Oidc.SetClientConfigActivationResponse::class,
      StreamType.UNARY,
    ),
  )
