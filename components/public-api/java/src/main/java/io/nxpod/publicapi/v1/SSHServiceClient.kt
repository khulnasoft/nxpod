...
public class SSHServiceClient(
  ...
  override suspend fun listSSHPublicKeys(request: Ssh.ListSSHPublicKeysRequest, headers: Headers):
    ...
    "nxpod.v1.SSHService/ListSSHPublicKeys",
      io.nxpod.publicapi.v1.Ssh.ListSSHPublicKeysRequest::class,
      io.nxpod.publicapi.v1.Ssh.ListSSHPublicKeysResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun createSSHPublicKey(request: Ssh.CreateSSHPublicKeyRequest, headers: Headers):
    ...
    "nxpod.v1.SSHService/CreateSSHPublicKey",
      io.nxpod.publicapi.v1.Ssh.CreateSSHPublicKeyRequest::class,
      io.nxpod.publicapi.v1.Ssh.CreateSSHPublicKeyResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun deleteSSHPublicKey(request: Ssh.DeleteSSHPublicKeyRequest, headers: Headers):
    ...
    "nxpod.v1.SSHService/DeleteSSHPublicKey",
      io.nxpod.publicapi.v1.Ssh.DeleteSSHPublicKeyRequest::class,
      io.nxpod.publicapi.v1.Ssh.DeleteSSHPublicKeyResponse::class,
      StreamType.UNARY,
    ),
  )
