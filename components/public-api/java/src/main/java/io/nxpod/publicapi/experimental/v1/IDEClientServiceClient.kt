...
public class IDEClientServiceClient(
  ...
  override suspend fun sendHeartbeat(request: IdeClient.SendHeartbeatRequest, headers: Headers):
    ...
    "nxpod.experimental.v1.IDEClientService/SendHeartbeat",
      io.nxpod.publicapi.experimental.v1.IdeClient.SendHeartbeatRequest::class,
      io.nxpod.publicapi.experimental.v1.IdeClient.SendHeartbeatResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun sendDidClose(request: IdeClient.SendDidCloseRequest, headers: Headers):
    ...
    "nxpod.experimental.v1.IDEClientService/SendDidClose",
      io.nxpod.publicapi.experimental.v1.IdeClient.SendDidCloseRequest::class,
      io.nxpod.publicapi.experimental.v1.IdeClient.SendDidCloseResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun updateGitStatus(request: IdeClient.UpdateGitStatusRequest, headers: Headers):
    ...
    "nxpod.experimental.v1.IDEClientService/UpdateGitStatus",
      io.nxpod.publicapi.experimental.v1.IdeClient.UpdateGitStatusRequest::class,
      io.nxpod.publicapi.experimental.v1.IdeClient.UpdateGitStatusResponse::class,
      StreamType.UNARY,
    ),
  )
