...
public class InstallationServiceClient(
  ...
  override suspend
    ...
    "nxpod.v1.InstallationService/GetInstallationWorkspaceDefaultImage",
      io.nxpod.publicapi.v1.Installation.GetInstallationWorkspaceDefaultImageRequest::class,
      io.nxpod.publicapi.v1.Installation.GetInstallationWorkspaceDefaultImageResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun listBlockedRepositories(request: Installation.ListBlockedRepositoriesRequest,
    ...
    "nxpod.v1.InstallationService/ListBlockedRepositories",
      io.nxpod.publicapi.v1.Installation.ListBlockedRepositoriesRequest::class,
      io.nxpod.publicapi.v1.Installation.ListBlockedRepositoriesResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun createBlockedRepository(request: Installation.CreateBlockedRepositoryRequest,
    ...
    "nxpod.v1.InstallationService/CreateBlockedRepository",
      io.nxpod.publicapi.v1.Installation.CreateBlockedRepositoryRequest::class,
      io.nxpod.publicapi.v1.Installation.CreateBlockedRepositoryResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun deleteBlockedRepository(request: Installation.DeleteBlockedRepositoryRequest,
    ...
    "nxpod.v1.InstallationService/DeleteBlockedRepository",
      io.nxpod.publicapi.v1.Installation.DeleteBlockedRepositoryRequest::class,
      io.nxpod.publicapi.v1.Installation.DeleteBlockedRepositoryResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun listBlockedEmailDomains(request: Installation.ListBlockedEmailDomainsRequest,
    ...
    "nxpod.v1.InstallationService/ListBlockedEmailDomains",
      io.nxpod.publicapi.v1.Installation.ListBlockedEmailDomainsRequest::class,
      io.nxpod.publicapi.v1.Installation.ListBlockedEmailDomainsResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend
    ...
    "nxpod.v1.InstallationService/CreateBlockedEmailDomain",
      io.nxpod.publicapi.v1.Installation.CreateBlockedEmailDomainRequest::class,
      io.nxpod.publicapi.v1.Installation.CreateBlockedEmailDomainResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun getOnboardingState(request: Installation.GetOnboardingStateRequest,
    ...
    "nxpod.v1.InstallationService/GetOnboardingState",
      io.nxpod.publicapi.v1.Installation.GetOnboardingStateRequest::class,
      io.nxpod.publicapi.v1.Installation.GetOnboardingStateResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend
    ...
    "nxpod.v1.InstallationService/GetInstallationConfiguration",
      io.nxpod.publicapi.v1.Installation.GetInstallationConfigurationRequest::class,
      io.nxpod.publicapi.v1.Installation.GetInstallationConfigurationResponse::class,
      StreamType.UNARY,
    ),
  )
