...
public class TeamsServiceClient(
  ...
  override suspend fun createTeam(request: Teams.CreateTeamRequest, headers: Headers):
    ...
    "nxpod.experimental.v1.TeamsService/CreateTeam",
      io.nxpod.publicapi.experimental.v1.Teams.CreateTeamRequest::class,
      io.nxpod.publicapi.experimental.v1.Teams.CreateTeamResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun getTeam(request: Teams.GetTeamRequest, headers: Headers):
    ...
    "nxpod.experimental.v1.TeamsService/GetTeam",
      io.nxpod.publicapi.experimental.v1.Teams.GetTeamRequest::class,
      io.nxpod.publicapi.experimental.v1.Teams.GetTeamResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun listTeams(request: Teams.ListTeamsRequest, headers: Headers):
    ...
    "nxpod.experimental.v1.TeamsService/ListTeams",
      io.nxpod.publicapi.experimental.v1.Teams.ListTeamsRequest::class,
      io.nxpod.publicapi.experimental.v1.Teams.ListTeamsResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun deleteTeam(request: Teams.DeleteTeamRequest, headers: Headers):
    ...
    "nxpod.experimental.v1.TeamsService/DeleteTeam",
      io.nxpod.publicapi.experimental.v1.Teams.DeleteTeamRequest::class,
      io.nxpod.publicapi.experimental.v1.Teams.DeleteTeamResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun getTeamInvitation(request: Teams.GetTeamInvitationRequest, headers: Headers):
    ...
    "nxpod.experimental.v1.TeamsService/GetTeamInvitation",
      io.nxpod.publicapi.experimental.v1.Teams.GetTeamInvitationRequest::class,
      io.nxpod.publicapi.experimental.v1.Teams.GetTeamInvitationResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun joinTeam(request: Teams.JoinTeamRequest, headers: Headers):
    ...
    "nxpod.experimental.v1.TeamsService/JoinTeam",
      io.nxpod.publicapi.experimental.v1.Teams.JoinTeamRequest::class,
      io.nxpod.publicapi.experimental.v1.Teams.JoinTeamResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun resetTeamInvitation(request: Teams.ResetTeamInvitationRequest,
    ...
    "nxpod.experimental.v1.TeamsService/ResetTeamInvitation",
      io.nxpod.publicapi.experimental.v1.Teams.ResetTeamInvitationRequest::class,
      io.nxpod.publicapi.experimental.v1.Teams.ResetTeamInvitationResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun listTeamMembers(request: Teams.ListTeamMembersRequest, headers: Headers):
    ...
    "nxpod.experimental.v1.TeamsService/ListTeamMembers",
      io.nxpod.publicapi.experimental.v1.Teams.ListTeamMembersRequest::class,
      io.nxpod.publicapi.experimental.v1.Teams.ListTeamMembersResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun updateTeamMember(request: Teams.UpdateTeamMemberRequest, headers: Headers):
    ...
    "nxpod.experimental.v1.TeamsService/UpdateTeamMember",
      io.nxpod.publicapi.experimental.v1.Teams.UpdateTeamMemberRequest::class,
      io.nxpod.publicapi.experimental.v1.Teams.UpdateTeamMemberResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun deleteTeamMember(request: Teams.DeleteTeamMemberRequest, headers: Headers):
    ...
    "nxpod.experimental.v1.TeamsService/DeleteTeamMember",
      io.nxpod.publicapi.experimental.v1.Teams.DeleteTeamMemberRequest::class,
      io.nxpod.publicapi.experimental.v1.Teams.DeleteTeamMemberResponse::class,
      StreamType.UNARY,
    ),
  )
