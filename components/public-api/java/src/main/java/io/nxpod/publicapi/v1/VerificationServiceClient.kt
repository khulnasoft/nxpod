...
public class VerificationServiceClient(
  ...
  override suspend
    ...
    "nxpod.v1.VerificationService/SendPhoneNumberVerificationToken",
      io.nxpod.publicapi.v1.Verification.SendPhoneNumberVerificationTokenRequest::class,
      io.nxpod.publicapi.v1.Verification.SendPhoneNumberVerificationTokenResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend
    ...
    "nxpod.v1.VerificationService/VerifyPhoneNumberVerificationToken",
      io.nxpod.publicapi.v1.Verification.VerifyPhoneNumberVerificationTokenRequest::class,
      io.nxpod.publicapi.v1.Verification.VerifyPhoneNumberVerificationTokenResponse::class,
      StreamType.UNARY,
    ),
  )
