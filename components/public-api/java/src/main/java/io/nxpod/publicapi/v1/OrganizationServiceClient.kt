...
public class OrganizationServiceClient(
  ...
  override suspend fun createOrganization(request: OrganizationOuterClass.CreateOrganizationRequest,
    ...
    "nxpod.v1.OrganizationService/CreateOrganization",
      io.nxpod.publicapi.v1.OrganizationOuterClass.CreateOrganizationRequest::class,
      io.nxpod.publicapi.v1.OrganizationOuterClass.CreateOrganizationResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun getOrganization(request: OrganizationOuterClass.GetOrganizationRequest,
    ...
    "nxpod.v1.OrganizationService/GetOrganization",
      io.nxpod.publicapi.v1.OrganizationOuterClass.GetOrganizationRequest::class,
      io.nxpod.publicapi.v1.OrganizationOuterClass.GetOrganizationResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun updateOrganization(request: OrganizationOuterClass.UpdateOrganizationRequest,
    ...
    "nxpod.v1.OrganizationService/UpdateOrganization",
      io.nxpod.publicapi.v1.OrganizationOuterClass.UpdateOrganizationRequest::class,
      io.nxpod.publicapi.v1.OrganizationOuterClass.UpdateOrganizationResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun listOrganizations(request: OrganizationOuterClass.ListOrganizationsRequest,
    ...
    "nxpod.v1.OrganizationService/ListOrganizations",
      io.nxpod.publicapi.v1.OrganizationOuterClass.ListOrganizationsRequest::class,
      io.nxpod.publicapi.v1.OrganizationOuterClass.ListOrganizationsResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun deleteOrganization(request: OrganizationOuterClass.DeleteOrganizationRequest,
    ...
    "nxpod.v1.OrganizationService/DeleteOrganization",
      io.nxpod.publicapi.v1.OrganizationOuterClass.DeleteOrganizationRequest::class,
      io.nxpod.publicapi.v1.OrganizationOuterClass.DeleteOrganizationResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend
    ...
    "nxpod.v1.OrganizationService/GetOrganizationInvitation",
      io.nxpod.publicapi.v1.OrganizationOuterClass.GetOrganizationInvitationRequest::class,
      io.nxpod.publicapi.v1.OrganizationOuterClass.GetOrganizationInvitationResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun joinOrganization(request: OrganizationOuterClass.JoinOrganizationRequest,
    ...
    "nxpod.v1.OrganizationService/JoinOrganization",
      io.nxpod.publicapi.v1.OrganizationOuterClass.JoinOrganizationRequest::class,
      io.nxpod.publicapi.v1.OrganizationOuterClass.JoinOrganizationResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend
    ...
    "nxpod.v1.OrganizationService/ResetOrganizationInvitation",
      io.nxpod.publicapi.v1.OrganizationOuterClass.ResetOrganizationInvitationRequest::class,
      io.nxpod.publicapi.v1.OrganizationOuterClass.ResetOrganizationInvitationResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend
    ...
    "nxpod.v1.OrganizationService/ListOrganizationMembers",
      io.nxpod.publicapi.v1.OrganizationOuterClass.ListOrganizationMembersRequest::class,
      io.nxpod.publicapi.v1.OrganizationOuterClass.ListOrganizationMembersResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend
    ...
    "nxpod.v1.OrganizationService/UpdateOrganizationMember",
      io.nxpod.publicapi.v1.OrganizationOuterClass.UpdateOrganizationMemberRequest::class,
      io.nxpod.publicapi.v1.OrganizationOuterClass.UpdateOrganizationMemberResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend
    ...
    "nxpod.v1.OrganizationService/DeleteOrganizationMember",
      io.nxpod.publicapi.v1.OrganizationOuterClass.DeleteOrganizationMemberRequest::class,
      io.nxpod.publicapi.v1.OrganizationOuterClass.DeleteOrganizationMemberResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend
    ...
    "nxpod.v1.OrganizationService/GetOrganizationSettings",
      io.nxpod.publicapi.v1.OrganizationOuterClass.GetOrganizationSettingsRequest::class,
      io.nxpod.publicapi.v1.OrganizationOuterClass.GetOrganizationSettingsResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend
    ...
    "nxpod.v1.OrganizationService/UpdateOrganizationSettings",
      io.nxpod.publicapi.v1.OrganizationOuterClass.UpdateOrganizationSettingsRequest::class,
      io.nxpod.publicapi.v1.OrganizationOuterClass.UpdateOrganizationSettingsResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend
    ...
    "nxpod.v1.OrganizationService/ListOrganizationWorkspaceClasses",
      io.nxpod.publicapi.v1.OrganizationOuterClass.ListOrganizationWorkspaceClassesRequest::class,
      io.nxpod.publicapi.v1.OrganizationOuterClass.ListOrganizationWorkspaceClassesResponse::class,
      StreamType.UNARY,
    ),
  )
