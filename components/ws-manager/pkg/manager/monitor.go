...
import (
	...
	"github.com/khulnasoft/nxpod/ws-manager/pkg/manager/internal/workpool"
	...
	"github.com/khulnasoft/nxpod/ws-manager/pkg/internal/util"
...
func (m *Monitor) Start() error {
	...
	// startup, see: https://github.com/khulnasoft/nxpod/issues/2537 and https://github.com/khulnasoft/nxpod/issues/2619
	...
	if twso.Pod != nil {
		...
		for _, c := range twso.Pod.Spec.Containers {
			for i, env := range c.Env {
				isNxpodVar := strings.HasPrefix(env.Name, "NXPOD_") || strings.HasPrefix(env.Name, "THEIA_")
				if isNxpodVar {
					continue
				}
