...
const (
	...
	workspaceExplicitFailAnnotation = "nxpod/explicitFail"

	// workspaceSnapshotAnnotation stores a workspace's snapshot if one was taken prior to shutdown
	workspaceSnapshotAnnotation = "nxpod/snapshot"
	...
	workspaceInitializerAnnotation = "nxpod/contentInitializer"
	...
	workspaceFailedBeforeStoppingAnnotation = "nxpod/failedBeforeStopping"
	...
	ingressPortsAnnotation = "nxpod/ingressPorts"
)
