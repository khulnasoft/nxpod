...
func NewIngressPortAllocator(config *IngressPortAllocatorConfig, clientset kubernetes.Interface, namespace string, wsPortURLTmpl string, nxpodHostURL string) (IngressPortAllocator, error) {
	if config == nil {
