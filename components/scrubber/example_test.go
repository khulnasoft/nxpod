...
func TestScrub(t *testing.T) {
	...
	// log.WithFieldSensitive("workspaceID", "nxpodio-nxpod-uesaddev73c").Info("hello world")
	scrubber.KeyValue("workspaceID", "nxpodio-nxpod-uesaddev73c") // -> [scrubbed:md5:ae3e415b124cdbac878e995cad169490]
