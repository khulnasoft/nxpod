	...
	tests := []struct {
	...
	}{
		{
			...
			Struct: &struct {
				...
				ContextURL   string
				LeaveMeAlone string
			}{Username: "foo", Email: "foo@bar.com", Password: "foobar", WorkspaceID: "nxpodio-nxpod-uesaddev73c", ContextURL: "https://github.com/khulnasoft/nxpod/pull/19402", LeaveMeAlone: "foo"},
			Expectation: Expectation{
				Result: &struct {
					Username     string
					Email        string
...
func TestJSON(t *testing.T) {
	...
	tests := []struct {
		...
		{
			// https://github.com/khulnasoft/security/issues/64
			Name:  "complex",
