...
import { NxpodFileParser } from './nxpod-file-parser';
...
@suite class TestNxpodFileParser {

    protected parser: NxpodFileParser;

    public before() {
        this.parser = new NxpodFileParser();
    }
...
module.exports = new TestNxpodFileParser()   // Only to circumvent no usage warning :-/
