...
export const NXPOD_HOST = "nxpod_host";

export class ConfigCatClient implements Client {
    constructor(private readonly client: IConfigCatClient, private readonly nxpodHost?: string) {}
...
export function attributesToUser(attributes: Attributes): ConfigCatUser {
    ...
    if (attributes.nxpodHost) {
        custom[NXPOD_HOST] = attributes.nxpodHost;
    }
