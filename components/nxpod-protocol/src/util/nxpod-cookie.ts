 ...
 * This is used by "nxpod.io" and "www.nxpod.khulnasoft.com" to display different content/buttons.
 */
...
export function options(domain: string): cookie.CookieSerializeOptions {
    ...
    return {
        ...
        sameSite: "lax", // default: true. "Lax" needed to ensure we see cookies from users that navigate to nxpod.io from external sites
        domain: `.${domain}`, // explicitly include subdomains to not only cover "nxpod.io", but also "www.nxpod.khulnasoft.com" or workspaces
    };
}
