...
export abstract class AbstractComponentEnv {
    ...
    readonly installationLongname: string = getEnvVar("NXPOD_INSTALLATION_LONGNAME")
    readonly installationShortname: string = getEnvVar("NXPOD_INSTALLATION_SHORTNAME")
}
