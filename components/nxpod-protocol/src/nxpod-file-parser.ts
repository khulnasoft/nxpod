...
const schema = require("../data/nxpod-schema.json");
...
export class NxpodFileParser {
    public parse(content: string, parseOptions = {}, defaultConfig: WorkspaceConfig = {}): ParseResult {
        ...
        try {
            ...
            log.error("Unparsable Nxpod configuration", err, { content });
            return {
                config: defaultConfig,
                validationErrors: ["Unparsable Nxpod configuration: " + err.toString()],
            };
        }
    }
}
