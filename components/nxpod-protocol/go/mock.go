...
// DeleteNxpodToken mocks base method.
func (m *MockAPIInterface) DeleteNxpodToken(ctx context.Context, tokenHash string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteNxpodToken", ctx, tokenHash)
	ret0, _ := ret[0].(error)
	return ret0
}

// DeleteNxpodToken indicates an expected call of DeleteNxpodToken.
func (mr *MockAPIInterfaceMockRecorder) DeleteNxpodToken(ctx, tokenHash interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteNxpodToken", reflect.TypeOf((*MockAPIInterface)(nil).DeleteNxpodToken), ctx, tokenHash)
}
...
// GenerateNewNxpodToken mocks base method.
func (m *MockAPIInterface) GenerateNewNxpodToken(ctx context.Context, options *GenerateNewNxpodTokenOptions) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GenerateNewNxpodToken", ctx, options)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GenerateNewNxpodToken indicates an expected call of GenerateNewNxpodToken.
func (mr *MockAPIInterfaceMockRecorder) GenerateNewNxpodToken(ctx, options interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GenerateNewNxpodToken", reflect.TypeOf((*MockAPIInterface)(nil).GenerateNewNxpodToken), ctx, options)
}
...
// GetNxpodTokenScopes mocks base method.
func (m *MockAPIInterface) GetNxpodTokenScopes(ctx context.Context, tokenHash string) ([]string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetNxpodTokenScopes", ctx, tokenHash)
	ret0, _ := ret[0].([]string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetNxpodTokenScopes indicates an expected call of GetNxpodTokenScopes.
func (mr *MockAPIInterfaceMockRecorder) GetNxpodTokenScopes(ctx, tokenHash interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetNxpodTokenScopes", reflect.TypeOf((*MockAPIInterface)(nil).GetNxpodTokenScopes), ctx, tokenHash)
}

// GetNxpodTokens mocks base method.
func (m *MockAPIInterface) GetNxpodTokens(ctx context.Context) ([]*APIToken, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetNxpodTokens", ctx)
	ret0, _ := ret[0].([]*APIToken)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetNxpodTokens indicates an expected call of GetNxpodTokens.
func (mr *MockAPIInterfaceMockRecorder) GetNxpodTokens(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetNxpodTokens", reflect.TypeOf((*MockAPIInterface)(nil).GetNxpodTokens), ctx)
}
