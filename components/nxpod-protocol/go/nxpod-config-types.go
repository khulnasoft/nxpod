...
// Github Configures Nxpod's GitHub app (deprecated)
type Github struct {
...
type NxpodConfig struct {
	...
	// Configures Nxpod's GitHub app (deprecated)
...
type Prebuilds_object struct {
	...
	// Add a Review in Nxpod badge to pull requests. Defaults to true.
	...
	// Add a label to a PR when it's prebuilt. Set to true to use the default label (prebuilt-in-nxpod) or set to a string to use a different label name. This is a beta feature and may be unreliable. Defaults to false.
