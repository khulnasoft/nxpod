...
type APIInterface interface {
	...
	GetNxpodTokenScopes(ctx context.Context, tokenHash string) (res []string, err error)
	...
	GetNxpodTokens(ctx context.Context) (res []*APIToken, err error)
	GenerateNewNxpodToken(ctx context.Context, options *GenerateNewNxpodTokenOptions) (res string, err error)
	DeleteNxpodToken(ctx context.Context, tokenHash string) (err error)
...
const (
	...
	// FunctionGetNxpodTokenScopes is the name of the GetNxpodTokenScopes function
	FunctionGetNxpodTokenScopes FunctionName = "getNxpodTokenScopes"
	...
	// FunctionGetNxpodTokens is the name of the getNxpodTokens function
	FunctionGetNxpodTokens FunctionName = "getNxpodTokens"
	// FunctionGenerateNewNxpodToken is the name of the generateNewNxpodToken function
	FunctionGenerateNewNxpodToken FunctionName = "generateNewNxpodToken"
	// FunctionDeleteNxpodToken is the name of the deleteNxpodToken function
	FunctionDeleteNxpodToken FunctionName = "deleteNxpodToken"
...
var errNotConnected = errors.New("not connected to Nxpod server")
...
// APIoverJSONRPC makes JSON RPC calls to the Nxpod server is the APIoverJSONRPC message type
...
// GetNxpodTokenScopes calls getNxpodTokenScopes on the server
func (gp *APIoverJSONRPC) GetNxpodTokenScopes(ctx context.Context, tokenHash string) (res []string, err error) {
	if gp == nil {
		err = errNotConnected
		return
	}
	...
	var result []string
	err = gp.C.Call(ctx, "getNxpodTokenScopes", _params, &result)
	if err != nil {
		return
	}
	res = result
...
// GetNxpodTokens calls getNxpodTokens on the server
func (gp *APIoverJSONRPC) GetNxpodTokens(ctx context.Context) (res []*APIToken, err error) {
	if gp == nil {
		err = errNotConnected
		return
	}
	...
	var result []*APIToken
	err = gp.C.Call(ctx, "getNxpodTokens", _params, &result)
	if err != nil {
		return
	}
	res = result
...
// GenerateNewNxpodToken calls generateNewNxpodToken on the server
func (gp *APIoverJSONRPC) GenerateNewNxpodToken(ctx context.Context, options *GenerateNewNxpodTokenOptions) (res string, err error) {
	if gp == nil {
		err = errNotConnected
		return
	}
	...
	var result string
	err = gp.C.Call(ctx, "generateNewNxpodToken", _params, &result)
	if err != nil {
		return
	}
	res = result
...
// DeleteNxpodToken calls deleteNxpodToken on the server
func (gp *APIoverJSONRPC) DeleteNxpodToken(ctx context.Context, tokenHash string) (err error) {
	if gp == nil {
		err = errNotConnected
		return
	}
	...
	err = gp.C.Call(ctx, "deleteNxpodToken", _params, nil)
	if err != nil {
		return
	}
...
type WorkspaceConfig struct {
	...
	// that is set by nxpod at workspace creation time.
...
// GenerateNewNxpodTokenOptions is the GenerateNewNxpodTokenOptions message type
type GenerateNewNxpodTokenOptions struct {
	Name string `json:"name,omitempty"`
...
type User struct {
	...
	// A map of random settings that alter the behaviour of Nxpod on a per-user basis
