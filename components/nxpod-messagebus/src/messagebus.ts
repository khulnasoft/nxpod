...
export interface MessageBusHelper {
    /**
     * The name of the nxpod workspace exchange
     */
    workspaceExchange: string;

    /**
     * Ensures that the nxpod workspace exchange is present
     */
...
export namespace MessageBusHelperImpl {
    export const WORKSPACE_EXCHANGE = "nxpod.ws";
    export const WORKSPACE_EXCHANGE_LOCAL = "nxpod.ws.local";
