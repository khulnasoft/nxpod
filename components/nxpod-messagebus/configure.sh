...
rabbitmqadmin --password=$RABBITMQ_DEFAULT_PASS --username=$RABBITMQ_DEFAULT_USER declare exchange name=nxpod.ws type=topic durable=true
rabbitmqadmin --password=$RABBITMQ_DEFAULT_PASS --username=$RABBITMQ_DEFAULT_USER declare exchange name=nxpod.ws.local type=topic durable=true
...
rabbitmqadmin --password=$RABBITMQ_DEFAULT_PASS --username=$RABBITMQ_DEFAULT_USER declare binding source=nxpod.ws.local destination=nxpod.ws routing_key="#"
