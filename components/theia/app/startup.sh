...
# This is the main entrypoint to workspace container in Nxpod. It is called (and controlled) by the supervisor
...
[ -d "/home/nxpod/.sdkman" ] && [ -z "$SDKMAN_DIR" ] && export SDKMAN_DIR="/home/nxpod/.sdkman"
[ -s /home/nxpod/.sdkman/bin/sdkman-init.sh ] && [ -z "$SDKMAN_VERSION" ] && source "/home/nxpod/.sdkman/bin/sdkman-init.sh"
[ -s ~/.nvm/nvm-lazy.sh ] && source ~/.nvm/nvm-lazy.sh

cd /theia/node_modules/@nxpod/nxpod-ide
exec /theia/node/bin/nxpod-node ./src-gen/backend/main.js $*
