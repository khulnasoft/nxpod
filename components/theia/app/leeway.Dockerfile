...
################ Alpine ####################
# copy nodejs from the official alpine-based image because of https://github.com/TypeFox/nxpod/issues/2579
...
COPY --from=builder_alpine /theia/node/bin/node /theia/node/bin/nxpod-node

ENV NXPOD_BUILT_IN_PLUGINS /theia/node_modules/@nxpod/nxpod-ide/plugins/
COPY components-theia-app--builtin-plugins/plugins/ ${NXPOD_BUILT_IN_PLUGINS}
