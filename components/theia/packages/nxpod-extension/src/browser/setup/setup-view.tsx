...
export class SetupView extends ReactWidget {
    ...
    constructor() {
        ...
        this.title.iconClass = 'nxpod-view-icon';
        this.addClass('nxpod-setup-view');
    ...
    private steps: Step[] = [
        {
            title: 'Create .nxpod.yml',
            description: <React.Fragment>
                <p>
                    Let's start by adding a <code>.nxpod.yml</code> in your project's root.
                </p>
            </React.Fragment>,
            actions: [
                {
                    label: 'Create .nxpod.yml',
                    onClick: async () => {
        ...
        },
        {
            ...
            description: <React.Fragment>
                <p>
                    Need additional tools? Add a <code>.nxpod.Dockerfile</code>.
                </p>
            </React.Fragment>,
            actions: [
                this.skipAction,
