...
import { CommitContext } from "@nxpod/nxpod-protocol";
import { NxpodInfoService } from "../../common/nxpod-info";
import { NxpodServiceProvider } from "../nxpod-service-provider";


export class NxpodPluginServer implements PluginServer {
    constructor(protected orig: PluginServer, protected serviceProvider: NxpodServiceProvider, protected info: NxpodInfoService) {    
    }
