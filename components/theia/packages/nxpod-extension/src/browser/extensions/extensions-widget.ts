...
export class ExtensionsWidget extends SourceTreeWidget {
    ...
    static FACTORY_ID = 'nxpod-extensions';
    static ID = (pluginKind: ResolvedPluginKind) => `nxpod-${pluginKind}-extensions`;
    ...
    protected async init(): Promise<void> {
        super.init();
        this.addClass('nxpod-extensions-view');
        this.id = ExtensionsWidget.ID(this.pluginTreeSource.pluginKind);
        this.title.iconClass = 'nxpod-extensions-view-icon';
        this.updateTitle();
