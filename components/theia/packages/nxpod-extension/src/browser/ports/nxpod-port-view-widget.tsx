...
import { PortConfig, PortVisibility } from "@nxpod/nxpod-protocol";
import { MiniBrowserOpenHandler } from "@theia/mini-browser/lib/browser/mini-browser-open-handler";
import { NxpodPortsService } from "./nxpod-ports-service";
...
@injectable()
export class NxpodPortViewWidget extends ReactWidget {
    @inject(MiniBrowserOpenHandler) protected miniBrowserOpenHandler: MiniBrowserOpenHandler;
    @inject(NxpodPortsService) protected portsService: NxpodPortsService;
    ...
    constructor() {
        ...
        this.title.label = NxpodPortViewWidget.LABEL;
    ...
    protected render(): React.ReactNode {
        return (<NxpodPortViewComponent portsService={this.portsService} openInBrowser={this.openInBrowser} openInMiniBrowser={this.openInMiniBrowser} userOwnsWorkspace={this.isWorkspaceOwner} />);
    }
...
interface NxpodPortViewState {
    instancePorts: PortConfig[];
    servedPorts: ServedPort[];
}
interface NxpodPortViewProps {
    userOwnsWorkspace: boolean;
    portsService: NxpodPortsService;
    openInBrowser: (url: string) => void;
    openInMiniBrowser: (url: string) => void;
}
class NxpodPortViewComponent extends React.Component<NxpodPortViewProps, NxpodPortViewState> {
    constructor(props: NxpodPortViewProps) {
        super(props);
        this.state = {
            instancePorts: [],
            servedPorts: []
