...
import { NavigatorContext, WorkspaceContext, Workspace, PullRequestContext, IssueContext } from "@nxpod/nxpod-protocol/lib/protocol";
...
@injectable()
export class NxpodOpenContext implements FrontendApplicationContribution, InitialGitHubDataProvider {
...
@injectable()
export class NxpodWorkspaceService extends WorkspaceService {
